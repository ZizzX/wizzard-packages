...
import { WizardProvider, useWizard, useWizardActions, useWizardState } from 'wizzard-stepper-react';
...
export default function TestNavigationControl() {
  ...
  const mode = (search.get('mode') || (userRole === 'admin' ? 'free' : 'visited')) as
    | 'sequential'
    | 'visited'
    | 'free';
  ...
  return (
    <div className="max-w-2xl mx-auto space-y-6">
      <div className="space-y-2">
        <h1 className="text-3xl font-black text-gray-900">Navigation Control Test</h1>
