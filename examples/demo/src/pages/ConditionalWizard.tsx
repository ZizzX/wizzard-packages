    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2">
                ...
                <p className="text-gray-500 text-sm">Decide which steps you want to see.</p>
            </div>
            ...
            <label className="flex items-center gap-4 p-4 rounded-xl border border-gray-200 bg-white hover:border-indigo-200 hover:bg-indigo-50/30 transition-all cursor-pointer group">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">Enable this to show an additional info step.</p>
                </div>
            </label>
        </div>
    )
    ...
    return (
        <div className="space-y-6">
             <div className="space-y-2">
                ...
                <p className="text-gray-500 text-sm">Enter the details for the second person.</p>
             </div>
             <Input
                label="Full Name"
    ...
    return (
        <div className="space-y-6">
            <div className="space-y-2 text-center py-4">
                ...
                <p className="text-gray-500">The wizard adjusted based on your selections.</p>
            </div>
            
            <div className="bg-gray-50 rounded-xl p-4 border border-gray-100">
                <p className="text-xs font-bold text-gray-400 uppercase tracking-wider mb-2">Final Data</p>
