  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-gray-500 text-sm">Create your credentials using RHF + Zod.</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-gray-500 text-sm">Protect your account with a strong password.</p>
      </div>
      ...
      <div className="space-y-4">
        ...
        <Input
          ...
          {...register('confirmPassword', {
             onChange: (e) => handleStepChange('confirmPassword', e.target.value)
          })}
        />
      </div>
    </div>
                    ...
                    {currentStep.id === 'review' && (
                        <div className="space-y-6">
                            <div className="space-y-2 text-center py-4">
                                ...
                                <p className="text-gray-500">Your account has been successfully configured.</p>
                            </div>
