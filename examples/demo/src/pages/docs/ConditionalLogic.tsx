    ...
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          Every step can have an optional{" "}
          <code className="text-indigo-600 font-bold">condition</code>{" "}
          predicate. If it returns <code className="text-rose-600">false</code>,
          the step is automatically removed from the navigation queue.
        </p>
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            ...
            <div className="pl-8 text-gray-500">
              // Only show if user is over 18 and owns a car
            </div>
            <div className="pl-8">
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-600 text-sm">
          The wizard re-evaluates all conditions whenever the state changes.
          This means your <code className="text-indigo-600">activeSteps</code>{" "}
          array is always synchronized with the global state.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm space-y-4">
            ...
            <p className="text-xs text-gray-600 leading-relaxed">
              ...
              <code className="text-indigo-500">getData('nested.field')</code>
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-600 text-sm leading-relaxed">
          The <code className="text-indigo-600 font-mono">condition</code>{" "}
          property supports both <strong>synchronous</strong>
          and <strong>asynchronous</strong> predicates. Sync conditions are
          evaluated on every change for instant feedback, while async conditions
          handle server-side checks seamlessly.
        </p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
          <div className="space-y-4">
            <div className="flex items-center gap-2 font-bold text-gray-800">
              ...
              <span>Async Conditions</span>
            </div>
            <p className="text-xs text-gray-500 leading-relaxed">
              Return a{" "}
              <code className="text-indigo-600">Promise&lt;boolean&gt;</code>.
              Useful for checking permissions or feature flags via API without
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-gray-500 leading-relaxed">
              Use <code className="text-indigo-600">beforeLeave</code> to
              perform async actions (like "Are you sure?" dialogs){" "}
              <strong>before</strong> navigating away from a step.
            </p>
          </div>
        </div>
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            ...
            <div className="pl-4 text-gray-500">
              // Prevent leaving if "Confirm" is false
            </div>
            <div className="pl-4">
            ...
            <div className="pl-8">
              ...
              <span className="text-emerald-400">(</span>
              <span className="text-amber-400">"Save changes?"</span>
              <span className="text-emerald-400">);</span>
            </div>
            <div className="pl-4 text-emerald-400">{"}"}</div>
            <div className="text-emerald-400">{"}"}</div>
