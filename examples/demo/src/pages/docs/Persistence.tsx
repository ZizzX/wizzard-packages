    ...
    <div className="space-y-16 animate-in fade-in slide-in-from-bottom-4 duration-500 pb-20">
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-600">
          The{" "}
          <code className="text-indigo-600 font-bold bg-indigo-50 px-1.5 py-0.5 rounded">
            PersistenceMode
          </code>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm space-y-3">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Data is only saved when you explicitly call the{" "}
              <code className="text-indigo-500">save()</code> action.
            </p>
          </div>
          <div className="p-6 bg-indigo-600 rounded-2xl text-white space-y-3 shadow-xl shadow-indigo-100">
            ...
            <p className="text-indigo-100 text-sm leading-relaxed">
              Saves progress whenever a user successfully navigates to a new
              step. Minimum overhead.
            </p>
          </div>
          <div className="p-6 bg-white rounded-2xl border border-gray-100 shadow-sm space-y-3">
            ...
            <p className="text-sm text-gray-600 leading-relaxed">
              Commits data on every keystroke. Best used with our built-in
              debouncing.
            </p>
          </div>
        </div>
      ...
      <section className="space-y-6">
        ...
        <p className="text-gray-600">
          For production apps, you often want to persist general info (Name) but
          keep sensitive info (Credit Card) strictly in memory.
        </p>
      ...
      <section className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              When a user submits the form, you should clear the persistent
              state to prevent old data from showing up on the next start.
            </p>
            <div className="bg-gray-950 rounded-xl p-6 font-mono text-[10px] shadow-lg">
              <pre className="text-gray-400">
                ...
                <br />
                <span className="text-purple-300">
                  // Only wipes the storage adapter
                </span>
                <br />
                <span className="text-indigo-300">clearStorage</span>
                <span className="text-emerald-400">();</span>
          ...
          <div className="space-y-4">
            ...
            <p className="text-sm text-gray-600">
              When using <code className="text-indigo-500">onChange</code> mode,
              use the
              <code className="text-indigo-500">debounceValidation</code> option
              to prevent hitting your storage adapter too hard on every
              keystroke.
            </p>
            <div className="bg-gray-950 rounded-xl p-6 font-mono text-[10px] shadow-lg">
              <pre className="text-gray-400">
        ...
        <ProTip>
          Always call <code className="text-blue-900 font-bold">reset()</code>
          when a user successfully completes the wizard. This prevents old data
          from appearing on their next visit.
        </ProTip>
      </section>
