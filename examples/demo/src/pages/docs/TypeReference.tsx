        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            <div>
              ...
              <span className="text-amber-400">IWizardContext</span>
              <span className="text-emerald-400">&lt;</span>
              <span className="text-indigo-300">TData</span>
              <span className="text-emerald-400">&gt; {"{"}</span>
            </div>
            <div className="pl-4">
              <span className="text-indigo-400">wizardData</span>
              <span className="text-emerald-400">:</span>{" "}
              <span className="text-indigo-300">TData</span>
              <span className="text-emerald-400">;</span>{" "}
              <span className="text-gray-500">
                // Global state of all steps
              </span>
            </div>
            <div className="pl-4">
              <span className="text-indigo-400">activeSteps</span>
              <span className="text-emerald-400">:</span>{" "}
              <span className="text-amber-400">IStepConfig</span>
              <span className="text-emerald-400">[];</span>{" "}
              <span className="text-gray-500">
                // Currently visible steps based on conditions
              </span>
            </div>
            <div className="pl-4">
              <span className="text-indigo-400">currentStepIndex</span>
              <span className="text-emerald-400">:</span>{" "}
              <span className="text-rose-400">number</span>
              <span className="text-emerald-400">;</span>{" "}
              <span className="text-gray-500">
                // Actual index in activeSteps
              </span>
            </div>
            <div className="pl-4">
              ...
              <span className="text-rose-400">string</span>
              <span className="text-emerald-400">&gt;;</span>{" "}
              <span className="text-gray-500">// Validation errors map</span>
            </div>
            <div className="pl-4">
            ...
            <div className="pl-4">
              ...
              <span className="text-emerald-400">&gt;;</span>{" "}
              <span className="text-gray-500">
                // IDs of all steps the user has seen
              </span>
            </div>
            <div className="pl-4">
              <span className="text-indigo-400">completedSteps</span>
              <span className="text-emerald-400">:</span>{" "}
              <span className="text-amber-400">Set</span>
              <span className="text-emerald-400">&lt;</span>
              <span className="text-rose-400">string</span>
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            <div>
              ...
              <span className="text-amber-400">IStepConfig</span>
              <span className="text-emerald-400">&lt;</span>
              <span className="text-indigo-300">TStepData</span>
              <span className="text-emerald-400">,</span>{" "}
            ...
            <div className="pl-4">
              ...
              <span className="text-emerald-400">;</span>{" "}
              <span className="text-gray-500">
                // Must be unique within the wizard
              </span>
            </div>
            <div className="pl-4">
            ...
            <div className="pl-4">
              ...
              <span className="text-emerald-400">.</span>
              <span className="text-amber-400">ComponentType</span>
              <span className="text-emerald-400">&lt;</span>
              <span className="text-rose-400">any</span>
              <span className="text-emerald-400">&gt;;</span>{" "}
              <span className="text-gray-500">// Supports lazy()</span>
            </div>
            <div className="text-emerald-400">{"}"}</div>
          </pre>
        </div>
        ...
        <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
          <pre className="space-y-2 text-gray-400">
            <div>
              ...
              <span className="text-emerald-400">&lt;</span>
              <span className="text-indigo-300">TSchema</span>
              <span className="text-emerald-400">&gt; {"{"}</span>
            </div>
            <div className="pl-4">
            ...
            <div className="pl-4">
              <span className="text-indigo-400">autoValidate</span>
              <span className="text-emerald-400">?</span>
              <span className="text-emerald-400">:</span>{" "}
              <span className="text-rose-400">boolean</span>
              <span className="text-emerald-400">;</span>{" "}
            ...
            <div className="bg-gray-950 rounded-2xl p-8 font-mono text-xs overflow-x-auto shadow-2xl ring-1 ring-white/10">
              <pre className="space-y-2 text-gray-400">
                <div>
                  ...
                  <span className="text-rose-400">ValidationResult</span>{" "}
                  <span className="text-emerald-400">=</span>{" "}
                  <span className="text-emerald-400">{"{"}</span>
                </div>
                <div className="pl-4">
                ...
                <div className="pl-4">
                  ...
                  <span className="text-rose-400">string</span>
                  <span className="text-emerald-400">&gt;;</span>{" "}
                  <span className="text-gray-500">// Flattened error map</span>
                </div>
                <div className="text-emerald-400">{"}"}</div>
              </pre>
            </div>
