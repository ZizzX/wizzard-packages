      ...
      <section className="space-y-6">
        ...
        <div className="bg-gray-950 rounded-3xl p-8 font-mono text-[12px] shadow-2xl ring-1 ring-white/10">
          <div className="space-y-2 text-gray-400 border-l-2 border-yellow-500/30 pl-6">
            <div><span className="text-purple-400">const</span> <span className="text-emerald-400">{"{"}</span> <span className="text-indigo-300">updateData</span><span className="text-emerald-400">,</span> <span className="text-indigo-300">goToNextStep</span> <span className="text-emerald-400">{"}"}</span> <span className="text-emerald-400">=</span> <span className="text-indigo-300">useWizardActions</span><span className="text-emerald-400">();</span></div>
            <div className="pt-2"><span className="text-purple-400">const</span> <span className="text-indigo-300">form</span> <span className="text-emerald-400">=</span> <span className="text-indigo-300">useForm</span><span className="text-emerald-400">(</span><span className="text-emerald-400">{"{"}</span></div>
            ...
            <div className="pl-8 text-gray-500 italic">// Atomic sync to wizard store</div>
            <div className="pl-8"><span className="text-indigo-300">updateData</span><span className="text-emerald-400">(</span><span className="text-emerald-400">{"{"}</span> <span className="text-sky-300">user</span><span className="text-emerald-400">:</span> <span className="text-indigo-300">values</span> <span className="text-emerald-400">{"}"}</span><span className="text-emerald-400">)</span><span className="text-emerald-400">;</span></div>
