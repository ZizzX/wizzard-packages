import { WizardProvider, useWizard, type IWizardConfig, LocalStorageAdapter, type IValidatorAdapter, type ValidationResult } from 'wizzard-stepper-react';
...
class SimpleValidator<T> implements IValidatorAdapter<T> {
    ...
    async validate(data: T): Promise<ValidationResult> {
        ...
        const errors = this.validateFn(data);
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-gray-500 text-sm">Please tell us a bit about yourself.</p>
      </div>
  ...
  return (
    <div className="space-y-6">
      <div className="space-y-2">
        ...
        <p className="text-gray-500 text-sm">Check your information before submitting.</p>
      </div>
...
// 2. Define Validators
const personalValidator = new SimpleValidator((data: any) => {
...
const contactValidator = new SimpleValidator((data: any) => {
    const errors: Record<string, string> = {};
