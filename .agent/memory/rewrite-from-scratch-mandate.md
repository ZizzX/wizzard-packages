...
Given 2026-09-06 on resuming after T29: "запомни мы пишем новое приложение,
библиотеку! и только если необходимо пишем поддержку старого, но все пишем
можно сказать с нуля, правильно и граммотно!"
...
2. **`README.md`** — full rewrite. The user's verdict on the current one: "не
   красивая и видно что написана с помощью ИИ". It must read as a human-written,
   best-in-class library README (compare the reference READMEs of zustand,
   xstate, tanstack). Diagnosis of what is wrong today lives in
