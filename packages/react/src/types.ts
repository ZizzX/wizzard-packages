import type { IWizardState, IWizardActions as ICoreActions, IWizardContext as ICoreContext, IStepConfig, IWizardConfig } from '@wizzard/core';
 ...
 */
export interface IWizardContext<T = unknown, StepId extends string = string> extends ICoreContext<T, StepId> { }
