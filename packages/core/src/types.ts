...
export type WizardEventPayloads<StepId extends string = string> = {
    ...
    validation_error: { stepId: StepId; errors: Record<string, string> | undefined; timestamp: number; };
 ...
 */
export interface IWizardContext<T = unknown, StepId extends string = string> extends Omit<IWizardState<T, StepId>, 'errors'>, IWizardActions<StepId> {
    /**
