...
test.describe('Basic Navigation', () => {
  ...
  test('should render initial state correctly', async ({ page }) => {
    ...
    await expect(page.locator('[data-testid="step-indicator"]').nth(0)).toHaveClass(/bg-indigo-600/);
    await expect(page.locator('[data-testid="step-indicator"]').nth(1)).not.toHaveClass(/bg-indigo-600/);
  });
