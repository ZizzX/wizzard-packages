...
`});const p={type:"element",tagName:"li",properties:d,children:f};return a.patch(r,p),a.applyData(r,p)}function V1(a){let r=!1;if(a.type==="list"){r=a.spread||!1;const l=a.children;let s=-1;for(;!r&&++s<l.length;)r=by(l[s])}return r}function by(a){const r=a.spread;return r??a.children.length>1}function q1(a,r){const l={},s=a.all(r);let u=-1;for(typeof r.start=="number"&&r.start!==1&&(l.start=r.start);++u<s.length;){const f=s[u];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const d={type:"element",tagName:r.ordered?"ol":"ul",properties:l,children:a.wrap(s,!0)};return a.patch(r,d),a.applyData(r,d)}function Y1(a,r){const l={type:"element",tagName:"p",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}function G1(a,r){const l={type:"root",children:a.wrap(a.all(r))};return a.patch(r,l),a.applyData(r,l)}function Q1(a,r){const l={type:"element",tagName:"strong",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}function F1(a,r){const l=a.all(r),s=l.shift(),u=[];if(s){const f={type:"element",tagName:"thead",properties:{},children:a.wrap([s],!0)};a.patch(r.children[0],f),u.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:a.wrap(l,!0)},h=ud(r.children[1]),g=Jg(r.children[r.children.length-1]);h&&g&&(f.position={start:h,end:g}),u.push(f)}const d={type:"element",tagName:"table",properties:{},children:a.wrap(u,!0)};return a.patch(r,d),a.applyData(r,d)}function K1(a,r,l){const s=l?l.children:void 0,d=(s?s.indexOf(r):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,h=f?f.length:r.children.length;let g=-1;const p=[];for(;++g<h;){const b=r.children[g],v={},S=f?f[g]:void 0;S&&(v.align=S);let L={type:"element",tagName:d,properties:v,children:[]};b&&(L.children=a.all(b),a.patch(b,L),L=a.applyData(b,L)),p.push(L)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(p,!0)};return a.patch(r,y),a.applyData(r,y)}function J1(a,r){const l={type:"element",tagName:"td",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}const sg=9,og=32;function $1(a){const r=String(a),l=/\r?\n|\r/g;let s=l.exec(r),u=0;const d=[];for(;s;)d.push(cg(r.slice(u,s.index),u>0,!0),s[0]),u=s.index+s[0].length,s=l.exec(r);return d.push(cg(r.slice(u),u>0,!1)),d.join("")}function cg(a,r,l){let s=0,u=a.length;if(r){let d=a.codePointAt(s);for(;d===sg||d===og;)s++,d=a.codePointAt(s)}if(l){let d=a.codePointAt(u-1);for(;d===sg||d===og;)u--,d=a.codePointAt(u-1)}return u>s?a.slice(s,u):""}function e3(a,r){const l={type:"text",value:$1(String(r.value))};return a.patch(r,l),a.applyData(r,l)}function n3(a,r){const l={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(r,l),a.applyData(r,l)}const t3={blockquote:_1,break:M1,code:C1,delete:L1,emphasis:W1,footnoteReference:O1,heading:P1,html:N1,imageReference:U1,image:j1,inlineCode:B1,linkReference:X1,link:Z1,listItem:H1,list:q1,paragraph:Y1,root:G1,strong:Q1,table:F1,tableCell:J1,tableRow:K1,text:e3,thematicBreak:n3,toml:Zs,yaml:Zs,definition:Zs,footnoteDefinition:Zs};function Zs(){}const zy=-1,io=0,vl=1,Js=2,yd=3,bd=4,zd=5,Sd=6,Sy=7,vy=8,ug=typeof self=="object"?self:globalThis,a3=(a,r)=>{const l=(u,d)=>(a.set(d,u),u),s=u=>{if(a.has(u))return a.get(u);const[d,f]=r[u];switch(d){case io:case zy:return l(f,u);case vl:{const h=l([],u);for(const g of f)h.push(s(g));return h}case Js:{const h=l({},u);for(const[g,p]of f)h[s(g)]=s(p);return h}case yd:return l(new Date(f),u);case bd:{const{source:h,flags:g}=f;return l(new RegExp(h,g),u)}case zd:{const h=l(new Map,u);for(const[g,p]of f)h.set(s(g),s(p));return h}case Sd:{const h=l(new Set,u);for(const g of f)h.add(s(g));return h}case Sy:{const{name:h,message:g}=f;return l(new ug[h](g),u)}case vy:return l(BigInt(f),u);case"BigInt":return l(Object(BigInt(f)),u);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:h}=new Uint8Array(f);return l(new DataView(h),f)}}return l(new ug[d](f),u)};return s},dg=a=>a3(new Map,a)(0),hr="",{toString:i3}={},{keys:r3}=Object,yl=a=>{const r=typeof a;if(r!=="object"||!a)return[io,r];const l=i3.call(a).slice(8,-1);switch(l){case"Array":return[vl,hr];case"Object":return[Js,hr];case"Date":return[yd,hr];case"RegExp":return[bd,hr];case"Map":return[zd,hr];case"Set":return[Sd,hr];case"DataView":return[vl,l]}return l.includes("Array")?[vl,l]:l.includes("Error")?[Sy,l]:[Js,l]},Hs=([a,r])=>a===io&&(r==="function"||r==="symbol"),l3=(a,r,l,s)=>{const u=(f,h)=>{const g=s.push(f)-1;return l.set(h,g),g},d=f=>{if(l.has(f))return l.get(f);let[h,g]=yl(f);switch(h){case io:{let y=f;switch(g){case"bigint":h=vy,y=f.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+g);y=null;break;case"undefined":return u([zy],f)}return u([h,y],f)}case vl:{if(g){let v=f;return g==="DataView"?v=new Uint8Array(f.buffer):g==="ArrayBuffer"&&(v=new Uint8Array(f)),u([g,[...v]],f)}const y=[],b=u([h,y],f);for(const v of f)y.push(d(v));return b}case Js:{if(g)switch(g){case"BigInt":return u([g,f.toString()],f);case"Boolean":case"Number":case"String":return u([g,f.valueOf()],f)}if(r&&"toJSON"in f)return d(f.toJSON());const y=[],b=u([h,y],f);for(const v of r3(f))(a||!Hs(yl(f[v])))&&y.push([d(v),d(f[v])]);return b}case yd:return u([h,f.toISOString()],f);case bd:{const{source:y,flags:b}=f;return u([h,{source:y,flags:b}],f)}case zd:{const y=[],b=u([h,y],f);for(const[v,S]of f)(a||!(Hs(yl(v))||Hs(yl(S))))&&y.push([d(v),d(S)]);return b}case Sd:{const y=[],b=u([h,y],f);for(const v of f)(a||!Hs(yl(v)))&&y.push(d(v));return b}}const{message:p}=f;return u([h,{name:g,message:p}],f)};return d},fg=(a,{json:r,lossy:l}={})=>{const s=[];return l3(!(r||l),!!r,new Map,s)(a),s},$s=typeof structuredClone=="function"?(a,r)=>r&&("json"in r||"lossy"in r)?dg(fg(a,r)):structuredClone(a):(a,r)=>dg(fg(a,r));function s3(a,r){const l=[{type:"text",value:"↩"}];return r>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(r)}]}),l}function o3(a,r){return"Back to reference "+(a+1)+(r>1?"-"+r:"")}function c3(a){const r=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",l=a.options.footnoteBackContent||s3,s=a.options.footnoteBackLabel||o3,u=a.options.footnoteLabel||"Footnotes",d=a.options.footnoteLabelTagName||"h2",f=a.options.footnoteLabelProperties||{className:["sr-only"]},h=[];let g=-1;for(;++g<a.footnoteOrder.length;){const p=a.footnoteById.get(a.footnoteOrder[g]);if(!p)continue;const y=a.all(p),b=String(p.identifier).toUpperCase(),v=zr(b.toLowerCase());let S=0;const L=[],O=a.footnoteCounts.get(b);for(;O!==void 0&&++S<=O;){L.length>0&&L.push({type:"text",value:" "});let G=typeof l=="string"?l:l(g,S);typeof G=="string"&&(G={type:"text",value:G}),L.push({type:"element",tagName:"a",properties:{href:"#"+r+"fnref-"+v+(S>1?"-"+S:""),dataFootnoteBackref:"",ariaLabel:typeof s=="string"?s:s(g,S),className:["data-footnote-backref"]},children:Array.isArray(G)?G:[G]})}const Z=y[y.length-1];if(Z&&Z.type==="element"&&Z.tagName==="p"){const G=Z.children[Z.children.length-1];G&&G.type==="text"?G.value+=" ":Z.children.push({type:"text",value:" "}),Z.children.push(...L)}else y.push(...L);const U={type:"element",tagName:"li",properties:{id:r+"fn-"+v},children:a.wrap(y,!0)};a.patch(p,U),h.push(U)}if(h.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:d,properties:{...$s(f),id:"footnote-label"},children:[{type:"text",value:u}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(h,!0)},{type:"text",value:`
`}]}}const Ey=(function(a){if(a==null)return p3;if(typeof a=="function")return ro(a);if(typeof a=="object")return Array.isArray(a)?u3(a):d3(a);if(typeof a=="string")return f3(a);throw new Error("Expected function, string, or object as test")});function u3(a){const r=[];let l=-1;for(;++l<a.length;)r[l]=Ey(a[l]);return ro(s);function s(...u){let d=-1;for(;++d<r.length;)if(r[d].apply(this,u))return!0;return!1}}function d3(a){const r=a;return ro(l);function l(s){const u=s;let d;for(d in a)if(u[d]!==r[d])return!1;return!0}}function f3(a){return ro(r);function r(l){return l&&l.type===a}}function ro(a){return r;function r(l,s,u){return!!(h3(l)&&a.call(this,l,typeof s=="number"?s:void 0,u||void 0))}}function p3(){return!0}function h3(a){return a!==null&&typeof a=="object"&&"type"in a}const xy=[],m3=!0,pg=!1,g3="skip";function y3(a,r,l,s){let u;typeof r=="function"&&typeof l!="function"?(s=l,l=r):u=r;const d=Ey(u),f=s?-1:1;h(a,void 0,[])();function h(g,p,y){const b=g&&typeof g=="object"?g:{};if(typeof b.type=="string"){const S=typeof b.tagName=="string"?b.tagName:typeof b.name=="string"?b.name:void 0;Object.defineProperty(v,"name",{value:"node ("+(g.type+(S?"<"+S+">":""))+")"})}return v;function v(){let S=xy,L,O,Z;if((!r||d(g,p,y[y.length-1]||void 0))&&(S=b3(l(g,y)),S[0]===pg))return S;if("children"in g&&g.children){const U=g;if(U.children&&S[0]!==g3)for(O=(s?U.children.length:-1)+f,Z=y.concat(U);O>-1&&O<U.children.length;){const G=U.children[O];if(L=h(G,O,Z)(),L[0]===pg)return L;O=typeof L[1]=="number"?L[1]:O+f}}return S}}}function b3(a){return Array.isArray(a)?a:typeof a=="number"?[m3,a]:a==null?xy:[a]}function Dy(a,r,l,s){let u,d,f;typeof r=="function"&&typeof l!="function"?(d=void 0,f=r,u=l):(d=r,f=l,u=s),y3(a,d,h,u);function h(g,p){const y=p[p.length-1],b=y?y.children.indexOf(g):void 0;return f(g,b,y)}}const Ku={}.hasOwnProperty,z3={};function S3(a,r){const l=r||z3,s=new Map,u=new Map,d=new Map,f={...t3,...l.handlers},h={all:p,applyData:E3,definitionById:s,footnoteById:u,footnoteCounts:d,footnoteOrder:[],handlers:f,one:g,options:l,patch:v3,wrap:D3};return Dy(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const b=y.type==="definition"?s:u,v=String(y.identifier).toUpperCase();b.has(v)||b.set(v,y)}}),h;function g(y,b){const v=y.type,S=h.handlers[v];if(Ku.call(h.handlers,v)&&S)return S(h,y,b);if(h.options.passThrough&&h.options.passThrough.includes(v)){if("children"in y){const{children:O,...Z}=y,U=$s(Z);return U.children=h.all(y),U}return $s(y)}return(h.options.unknownHandler||x3)(h,y,b)}function p(y){const b=[];if("children"in y){const v=y.children;let S=-1;for(;++S<v.length;){const L=h.one(v[S],y);if(L){if(S&&v[S-1].type==="break"&&(!Array.isArray(L)&&L.type==="text"&&(L.value=hg(L.value)),!Array.isArray(L)&&L.type==="element")){const O=L.children[0];O&&O.type==="text"&&(O.value=hg(O.value))}Array.isArray(L)?b.push(...L):b.push(L)}}}return b}}function v3(a,r){a.position&&(r.position=iv(a))}function E3(a,r){let l=r;if(a&&a.data){const s=a.data.hName,u=a.data.hChildren,d=a.data.hProperties;if(typeof s=="string")if(l.type==="element")l.tagName=s;else{const f="children"in l?l.children:[l];l={type:"element",tagName:s,properties:{},children:f}}l.type==="element"&&d&&Object.assign(l.properties,$s(d)),"children"in l&&l.children&&u!==null&&u!==void 0&&(l.children=u)}return l}function x3(a,r){const l=r.data||{},s="value"in r&&!(Ku.call(l,"hProperties")||Ku.call(l,"hChildren"))?{type:"text",value:r.value}:{type:"element",tagName:"div",properties:{},children:a.all(r)};return a.patch(r,s),a.applyData(r,s)}function D3(a,r){const l=[];let s=-1;for(r&&l.push({type:"text",value:`
`});++s<a.length;)s&&l.push({type:"text",value:`
`}),l.push(a[s]);return r&&a.length>0&&l.push({type:"text",value:`
`}),l}function hg(a){let r=0,l=a.charCodeAt(r);for(;l===9||l===32;)r++,l=a.charCodeAt(r);return a.slice(r)}function mg(a,r){const l=S3(a,r),s=l.one(a,void 0),u=c3(l),d=Array.isArray(s)?{type:"root",children:s}:s||{type:"root",children:[]};return u&&d.children.push({type:"text",value:`
`},u),d}function T3(a,r){return a&&"run"in a?async function(l,s){const u=mg(l,{file:s,...r});await a.run(u,s)}:function(l,s){return mg(l,{file:s,...a||r})}}function gg(a){if(a)throw a}var Iu,yg;function A3(){if(yg)return Iu;yg=1;var a=Object.prototype.hasOwnProperty,r=Object.prototype.toString,l=Object.defineProperty,s=Object.getOwnPropertyDescriptor,u=function(p){return typeof Array.isArray=="function"?Array.isArray(p):r.call(p)==="[object Array]"},d=function(p){if(!p||r.call(p)!=="[object Object]")return!1;var y=a.call(p,"constructor"),b=p.constructor&&p.constructor.prototype&&a.call(p.constructor.prototype,"isPrototypeOf");if(p.constructor&&!y&&!b)return!1;var v;for(v in p);return typeof v>"u"||a.call(p,v)},f=function(p,y){l&&y.name==="__proto__"?l(p,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):p[y.name]=y.newValue},h=function(p,y){if(y==="__proto__")if(a.call(p,y)){if(s)return s(p,y).value}else return;return p[y]};return Iu=function g(){var p,y,b,v,S,L,O=arguments[0],Z=1,U=arguments.length,G=!1;for(typeof O=="boolean"&&(G=O,O=arguments[1]||{},Z=2),(O==null||typeof O!="object"&&typeof O!="function")&&(O={});Z<U;++Z)if(p=arguments[Z],p!=null)for(y in p)b=h(O,y),v=h(p,y),O!==v&&(G&&v&&(d(v)||(S=u(v)))?(S?(S=!1,L=b&&u(b)?b:[]):L=b&&d(b)?b:{},f(O,{name:y,newValue:g(G,L,v)})):typeof v<"u"&&f(O,{name:y,newValue:v}));return O},Iu}var w3=A3();const _u=no(w3);function Ju(a){if(typeof a!="object"||a===null)return!1;const r=Object.getPrototypeOf(a);return(r===null||r===Object.prototype||Object.getPrototypeOf(r)===null)&&!(Symbol.toStringTag in a)&&!(Symbol.iterator in a)}function R3(){const a=[],r={run:l,use:s};return r;function l(...u){let d=-1;const f=u.pop();if(typeof f!="function")throw new TypeError("Expected function as last argument, not "+f);h(null,...u);function h(g,...p){const y=a[++d];let b=-1;if(g){f(g);return}for(;++b<u.length;)(p[b]===null||p[b]===void 0)&&(p[b]=u[b]);u=p,y?k3(y,h)(...p):f(null,...p)}}function s(u){if(typeof u!="function")throw new TypeError("Expected `middelware` to be a function, not "+u);return a.push(u),r}}function k3(a,r){let l;return s;function s(...f){const h=a.length>f.length;let g;h&&f.push(u);try{g=a.apply(this,f)}catch(p){const y=p;if(h&&l)throw y;return u(y)}h||(g&&g.then&&typeof g.then=="function"?g.then(d,u):g instanceof Error?u(g):d(g))}function u(f,...h){l||(l=!0,r(f,...h))}function d(f){u(null,f)}}const qt={basename:I3,dirname:_3,extname:M3,join:C3,sep:"/"};function I3(a,r){if(r!==void 0&&typeof r!="string")throw new TypeError('"ext" argument must be a string');Il(a);let l=0,s=-1,u=a.length,d;if(r===void 0||r.length===0||r.length>a.length){for(;u--;)if(a.codePointAt(u)===47){if(d){l=u+1;break}}else s<0&&(d=!0,s=u+1);return s<0?"":a.slice(l,s)}if(r===a)return"";let f=-1,h=r.length-1;for(;u--;)if(a.codePointAt(u)===47){if(d){l=u+1;break}}else f<0&&(d=!0,f=u+1),h>-1&&(a.codePointAt(u)===r.codePointAt(h--)?h<0&&(s=u):(h=-1,s=f));return l===s?s=f:s<0&&(s=a.length),a.slice(l,s)}function _3(a){if(Il(a),a.length===0)return".";let r=-1,l=a.length,s;for(;--l;)if(a.codePointAt(l)===47){if(s){r=l;break}}else s||(s=!0);return r<0?a.codePointAt(0)===47?"/":".":r===1&&a.codePointAt(0)===47?"//":a.slice(0,r)}function M3(a){Il(a);let r=a.length,l=-1,s=0,u=-1,d=0,f;for(;r--;){const h=a.codePointAt(r);if(h===47){if(f){s=r+1;break}continue}l<0&&(f=!0,l=r+1),h===46?u<0?u=r:d!==1&&(d=1):u>-1&&(d=-1)}return u<0||l<0||d===0||d===1&&u===l-1&&u===s+1?"":a.slice(u,l)}function C3(...a){let r=-1,l;for(;++r<a.length;)Il(a[r]),a[r]&&(l=l===void 0?a[r]:l+"/"+a[r]);return l===void 0?".":L3(l)}function L3(a){Il(a);const r=a.codePointAt(0)===47;let l=W3(a,!r);return l.length===0&&!r&&(l="."),l.length>0&&a.codePointAt(a.length-1)===47&&(l+="/"),r?"/"+l:l}function W3(a,r){let l="",s=0,u=-1,d=0,f=-1,h,g;for(;++f<=a.length;){if(f<a.length)h=a.codePointAt(f);else{if(h===47)break;h=47}if(h===47){if(!(u===f-1||d===1))if(u!==f-1&&d===2){if(l.length<2||s!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(g=l.lastIndexOf("/"),g!==l.length-1){g<0?(l="",s=0):(l=l.slice(0,g),s=l.length-1-l.lastIndexOf("/")),u=f,d=0;continue}}else if(l.length>0){l="",s=0,u=f,d=0;continue}}r&&(l=l.length>0?l+"/..":"..",s=2)}else l.length>0?l+="/"+a.slice(u+1,f):l=a.slice(u+1,f),s=f-u-1;u=f,d=0}else h===46&&d>-1?d++:d=-1}return l}function Il(a){if(typeof a!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(a))}const O3={cwd:P3};function P3(){return"/"}function $u(a){return!!(a!==null&&typeof a=="object"&&"href"in a&&a.href&&"protocol"in a&&a.protocol&&a.auth===void 0)}function N3(a){if(typeof a=="string")a=new URL(a);else if(!$u(a)){const r=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+a+"`");throw r.code="ERR_INVALID_ARG_TYPE",r}if(a.protocol!=="file:"){const r=new TypeError("The URL must be of scheme file");throw r.code="ERR_INVALID_URL_SCHEME",r}return U3(a)}function U3(a){if(a.hostname!==""){const s=new TypeError('File URL host must be "localhost" or empty on darwin');throw s.code="ERR_INVALID_FILE_URL_HOST",s}const r=a.pathname;let l=-1;for(;++l<r.length;)if(r.codePointAt(l)===37&&r.codePointAt(l+1)===50){const s=r.codePointAt(l+2);if(s===70||s===102){const u=new TypeError("File URL path must not include encoded / characters");throw u.code="ERR_INVALID_FILE_URL_PATH",u}}return decodeURIComponent(r)}const Mu=["history","path","basename","stem","extname","dirname"];class Ty{constructor(r){let l;r?$u(r)?l={path:r}:typeof r=="string"||j3(r)?l={value:r}:l=r:l={},this.cwd="cwd"in l?"":O3.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let s=-1;for(;++s<Mu.length;){const d=Mu[s];d in l&&l[d]!==void 0&&l[d]!==null&&(this[d]=d==="history"?[...l[d]]:l[d])}let u;for(u in l)Mu.includes(u)||(this[u]=l[u])}get basename(){return typeof this.path=="string"?qt.basename(this.path):void 0}set basename(r){Lu(r,"basename"),Cu(r,"basename"),this.path=qt.join(this.dirname||"",r)}get dirname(){return typeof this.path=="string"?qt.dirname(this.path):void 0}set dirname(r){bg(this.basename,"dirname"),this.path=qt.join(r||"",this.basename)}get extname(){return typeof this.path=="string"?qt.extname(this.path):void 0}set extname(r){if(Cu(r,"extname"),bg(this.dirname,"extname"),r){if(r.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(r.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=qt.join(this.dirname,this.stem+(r||""))}get path(){return this.history[this.history.length-1]}set path(r){$u(r)&&(r=N3(r)),Lu(r,"path"),this.path!==r&&this.history.push(r)}get stem(){return typeof this.path=="string"?qt.basename(this.path,this.extname):void 0}set stem(r){Lu(r,"stem"),Cu(r,"stem"),this.path=qt.join(this.dirname||"",r+(this.extname||""))}fail(r,l,s){const u=this.message(r,l,s);throw u.fatal=!0,u}info(r,l,s){const u=this.message(r,l,s);return u.fatal=void 0,u}message(r,l,s){const u=new Zn(r,l,s);return this.path&&(u.name=this.path+":"+u.name,u.file=this.path),u.fatal=!1,this.messages.push(u),u}toString(r){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(r||void 0).decode(this.value)}}function Cu(a,r){if(a&&a.includes(qt.sep))throw new Error("`"+r+"` cannot be a path: did not expect `"+qt.sep+"`")}function Lu(a,r){if(!a)throw new Error("`"+r+"` cannot be empty")}function bg(a,r){if(!a)throw new Error("Setting `"+r+"` requires `path` to be set too")}function j3(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const B3=(function(a){const s=this.constructor.prototype,u=s[a],d=function(){return u.apply(d,arguments)};return Object.setPrototypeOf(d,s),d}),X3={}.hasOwnProperty;class vd extends B3{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=R3()}copy(){const r=new vd;let l=-1;for(;++l<this.attachers.length;){const s=this.attachers[l];r.use(...s)}return r.data(_u(!0,{},this.namespace)),r}data(r,l){return typeof r=="string"?arguments.length===2?(Pu("data",this.frozen),this.namespace[r]=l,this):X3.call(this.namespace,r)&&this.namespace[r]||void 0:r?(Pu("data",this.frozen),this.namespace=r,this):this.namespace}freeze(){if(this.frozen)return this;const r=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...s]=this.attachers[this.freezeIndex];if(s[0]===!1)continue;s[0]===!0&&(s[0]=void 0);const u=l.call(r,...s);typeof u=="function"&&this.transformers.use(u)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(r){this.freeze();const l=Vs(r),s=this.parser||this.Parser;return Wu("parse",s),s(String(l),l)}process(r,l){const s=this;return this.freeze(),Wu("process",this.parser||this.Parser),Ou("process",this.compiler||this.Compiler),l?u(void 0,l):new Promise(u);function u(d,f){const h=Vs(r),g=s.parse(h);s.run(g,h,function(y,b,v){if(y||!b||!v)return p(y);const S=b,L=s.stringify(S,v);V3(L)?v.value=L:v.result=L,p(y,v)});function p(y,b){y||!b?f(y):d?d(b):l(void 0,b)}}}processSync(r){let l=!1,s;return this.freeze(),Wu("processSync",this.parser||this.Parser),Ou("processSync",this.compiler||this.Compiler),this.process(r,u),Sg("processSync","process",l),s;function u(d,f){l=!0,gg(d),s=f}}run(r,l,s){zg(r),this.freeze();const u=this.transformers;return!s&&typeof l=="function"&&(s=l,l=void 0),s?d(void 0,s):new Promise(d);function d(f,h){const g=Vs(l);u.run(r,g,p);function p(y,b,v){const S=b||r;y?h(y):f?f(S):s(void 0,S,v)}}}runSync(r,l){let s=!1,u;return this.run(r,l,d),Sg("runSync","run",s),u;function d(f,h){gg(f),u=h,s=!0}}stringify(r,l){this.freeze();const s=Vs(l),u=this.compiler||this.Compiler;return Ou("stringify",u),zg(r),u(r,s)}use(r,...l){const s=this.attachers,u=this.namespace;if(Pu("use",this.frozen),r!=null)if(typeof r=="function")g(r,l);else if(typeof r=="object")Array.isArray(r)?h(r):f(r);else throw new TypeError("Expected usable value, not `"+r+"`");return this;function d(p){if(typeof p=="function")g(p,[]);else if(typeof p=="object")if(Array.isArray(p)){const[y,...b]=p;g(y,b)}else f(p);else throw new TypeError("Expected usable value, not `"+p+"`")}function f(p){if(!("plugins"in p)&&!("settings"in p))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");h(p.plugins),p.settings&&(u.settings=_u(!0,u.settings,p.settings))}function h(p){let y=-1;if(p!=null)if(Array.isArray(p))for(;++y<p.length;){const b=p[y];d(b)}else throw new TypeError("Expected a list of plugins, not `"+p+"`")}function g(p,y){let b=-1,v=-1;for(;++b<s.length;)if(s[b][0]===p){v=b;break}if(v===-1)s.push([p,...y]);else if(y.length>0){let[S,...L]=y;const O=s[v][1];Ju(O)&&Ju(S)&&(S=_u(!0,O,S)),s[v]=[p,S,...L]}}}}const Z3=new vd().freeze();function Wu(a,r){if(typeof r!="function")throw new TypeError("Cannot `"+a+"` without `parser`")}function Ou(a,r){if(typeof r!="function")throw new TypeError("Cannot `"+a+"` without `compiler`")}function Pu(a,r){if(r)throw new Error("Cannot call `"+a+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function zg(a){if(!Ju(a)||typeof a.type!="string")throw new TypeError("Expected node, got `"+a+"`")}function Sg(a,r,l){if(!l)throw new Error("`"+a+"` finished async. Use `"+r+"` instead")}function Vs(a){return H3(a)?a:new Ty(a)}function H3(a){return!!(a&&typeof a=="object"&&"message"in a&&"messages"in a)}function V3(a){return typeof a=="string"||q3(a)}function q3(a){return!!(a&&typeof a=="object"&&"byteLength"in a&&"byteOffset"in a)}const Y3="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",vg=[],Eg={allowDangerousHtml:!0},G3=/^(https?|ircs?|mailto|xmpp)$/i,Q3=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function F3(a){const r=K3(a),l=J3(a);return $3(r.runSync(r.parse(l),l),a)}function K3(a){const r=a.rehypePlugins||vg,l=a.remarkPlugins||vg,s=a.remarkRehypeOptions?{...a.remarkRehypeOptions,...Eg}:Eg;return Z3().use(I1).use(l).use(T3,s).use(r)}function J3(a){const r=a.children||"",l=new Ty;return typeof r=="string"&&(l.value=r),l}function $3(a,r){const l=r.allowedElements,s=r.allowElement,u=r.components,d=r.disallowedElements,f=r.skipHtml,h=r.unwrapDisallowed,g=r.urlTransform||e4;for(const y of Q3)Object.hasOwn(r,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+Y3+y.id,void 0);return Dy(a,p),cv(a,{Fragment:Q.Fragment,components:u,ignoreInvalidStyle:!0,jsx:Q.jsx,jsxs:Q.jsxs,passKeys:!0,passNode:!0});function p(y,b,v){if(y.type==="raw"&&v&&typeof b=="number")return f?v.children.splice(b,1):v.children[b]={type:"text",value:y.value},b;if(y.type==="element"){let S;for(S in wu)if(Object.hasOwn(wu,S)&&Object.hasOwn(y.properties,S)){const L=y.properties[S],O=wu[S];(O===null||O.includes(y.tagName))&&(y.properties[S]=g(String(L||""),S,y))}}if(y.type==="element"){let S=l?!l.includes(y.tagName):d?d.includes(y.tagName):!1;if(!S&&s&&typeof b=="number"&&(S=!s(y,b,v)),S&&v&&typeof b=="number")return h&&y.children?v.children.splice(b,1,...y.children):v.children.splice(b,1),b}}}function e4(a){const r=a.indexOf(":"),l=a.indexOf("?"),s=a.indexOf("#"),u=a.indexOf("/");return r===-1||u!==-1&&r>u||l!==-1&&r>l||s!==-1&&r>s||G3.test(a.slice(0,r))?a:""}const n4=`**wizzard-packages**
...
Defined in: [adapter-yup/src/YupAdapter.ts:7](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/YupAdapter.ts#L7)
...
Defined in: [adapter-yup/src/YupAdapter.ts:10](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/YupAdapter.ts#L10)
...
Defined in: [adapter-yup/src/YupAdapter.ts:14](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/YupAdapter.ts#L14)
...
Defined in: [adapter-yup/src/types.ts:11](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/types.ts#L11)
...
Defined in: [adapter-yup/src/types.ts:12](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/types.ts#L12)
...
Defined in: [adapter-yup/src/types.ts:4](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/types.ts#L4)
...
Defined in: [adapter-yup/src/types.ts:5](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-yup/src/types.ts#L5)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:7](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-zod/src/ZodAdapter.ts#L7)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:10](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-zod/src/ZodAdapter.ts#L10)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:14](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-zod/src/ZodAdapter.ts#L14)
...
[\`IValidatorAdapter\`](../../../react/src/interfaces/IValidatorAdapter.md).[\`validate\`](../../../react/src/interfaces/IValidatorAdapter.md#validate)
`,o4="[**wizzard-packages**](../../../README.md)\n\n***\n\n[wizzard-packages](../../../README.md) / [adapter-zod/src](../README.md) / ZodLikeSchema\n\n# Interface: ZodLikeSchema\\<T\\>\n\nDefined in: [adapter-zod/src/types.ts:4](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-zod/src/types.ts#L4)\n\nMinimal structural interface for Zod-like schemas.\n\n## Type Parameters\n\n### T\n\n`T` = `any`\n\n## Properties\n\n### safeParseAsync()\n\n> **safeParseAsync**: (`data`) => `Promise`\\<\\{ `data?`: `T`; `error?`: \\{ `issues`: `object`[]; \\}; `success`: `boolean`; \\}\\>\n\nDefined in: [adapter-zod/src/types.ts:5](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/adapter-zod/src/types.ts#L5)\n\n#### Parameters\n\n##### data\n\n`T`\n\n#### Returns\n\n`Promise`\\<\\{ `data?`: `T`; `error?`: \\{ `issues`: `object`[]; \\}; `success`: `boolean`; \\}\\>\n",c4=`[**wizzard-packages**](../../README.md)
...
Defined in: [core/src/store/WizardStore.ts:17](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L17)
...
Defined in: [core/src/store/WizardStore.ts:38](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L38)
...
Defined in: [core/src/store/WizardStore.ts:23](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L23)
...
Defined in: [core/src/store/WizardStore.ts:534](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L534)
...
Defined in: [core/src/store/WizardStore.ts:439](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L439)
...
Defined in: [core/src/store/WizardStore.ts:97](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L97)
...
Defined in: [core/src/store/WizardStore.ts:285](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L285)
...
Defined in: [core/src/store/WizardStore.ts:775](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L775)
...
Defined in: [core/src/store/WizardStore.ts:471](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L471)
...
Defined in: [core/src/store/WizardStore.ts:463](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L463)
...
Defined in: [core/src/store/WizardStore.ts:616](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L616)
...
Defined in: [core/src/store/WizardStore.ts:547](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L547)
...
Defined in: [core/src/store/WizardStore.ts:377](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L377)
...
Defined in: [core/src/store/WizardStore.ts:419](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L419)
...
Defined in: [core/src/store/WizardStore.ts:458](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L458)
...
Defined in: [core/src/store/WizardStore.ts:29](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L29)
...
Defined in: [core/src/store/WizardStore.ts:296](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L296)
...
Defined in: [core/src/store/WizardStore.ts:406](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L406)
...
Defined in: [core/src/store/WizardStore.ts:330](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L330)
...
Defined in: [core/src/store/WizardStore.ts:751](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L751)
...
Defined in: [core/src/store/WizardStore.ts:692](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/store/WizardStore.ts#L692)
...
Defined in: [core/src/utils/data.ts:32](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/utils/data.ts#L32)
...
Defined in: [core/src/utils/data.ts:54](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/utils/data.ts#L54)
...
Defined in: [core/src/utils/data.ts:99](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/utils/data.ts#L99)
...
Defined in: [core/src/utils/data.ts:9](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/utils/data.ts#L9)
...
Defined in: [core/src/types.ts:311](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L311)
...
Defined in: [core/src/types.ts:312](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L312)
...
Defined in: [core/src/types.ts:313](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L313)
...
Defined in: [core/src/types.ts:314](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L314)
...
Defined in: [core/src/types.ts:141](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L141)
...
Defined in: [core/src/types.ts:146](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L146)
...
Defined in: [core/src/types.ts:145](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L145)
...
Defined in: [core/src/types.ts:143](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L143)
...
Defined in: [core/src/types.ts:144](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L144)
...
Defined in: [core/src/types.ts:142](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L142)
...
Defined in: [core/src/types.ts:157](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L157)
...
Defined in: [core/src/types.ts:179](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L179)
...
Defined in: [core/src/types.ts:169](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L169)
...
Defined in: [core/src/types.ts:189](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L189)
...
Defined in: [core/src/types.ts:185](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L185)
...
Defined in: [core/src/types.ts:181](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L181)
...
Defined in: [core/src/types.ts:160](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L160)
...
Defined in: [core/src/types.ts:168](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L168)
...
Defined in: [core/src/types.ts:184](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L184)
...
Defined in: [core/src/types.ts:158](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L158)
...
Defined in: [core/src/types.ts:159](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L159)
...
Defined in: [core/src/types.ts:182](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L182)
...
Defined in: [core/src/types.ts:183](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L183)
...
Defined in: [core/src/types.ts:167](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L167)
...
Defined in: [core/src/types.ts:177](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L177)
...
Defined in: [core/src/types.ts:180](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L180)
...
Defined in: [core/src/types.ts:125](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L125)
...
Defined in: [core/src/types.ts:126](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L126)
...
Defined in: [core/src/types.ts:90](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L90)
...
Defined in: [core/src/types.ts:106](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L106)
...
Defined in: [core/src/types.ts:110](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L110)
...
Defined in: [core/src/types.ts:91](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L91)
...
Defined in: [core/src/types.ts:92](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L92)
...
Defined in: [core/src/types.ts:93](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L93)
...
Defined in: [core/src/types.ts:99](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L99)
...
Defined in: [core/src/types.ts:107](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L107)
...
Defined in: [core/src/types.ts:105](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L105)
...
Defined in: [core/src/types.ts:108](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L108)
...
Defined in: [core/src/types.ts:98](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L98)
...
Defined in: [core/src/types.ts:111](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L111)
...
Defined in: [core/src/types.ts:109](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L109)
...
Defined in: [core/src/types.ts:101](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L101)
...
Defined in: [core/src/types.ts:100](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L100)
...
Defined in: [core/src/types.ts:201](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L201)
...
Defined in: [core/src/types.ts:214](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L214)
...
Defined in: [core/src/types.ts:204](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L204)
...
Defined in: [core/src/types.ts:217](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L217)
...
Defined in: [core/src/types.ts:218](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L218)
...
Defined in: [core/src/types.ts:213](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L213)
...
Defined in: [core/src/types.ts:219](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L219)
...
Defined in: [core/src/types.ts:207](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L207)
...
Defined in: [core/src/types.ts:202](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L202)
...
Defined in: [core/src/types.ts:206](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L206)
...
Defined in: [core/src/types.ts:205](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L205)
...
Defined in: [core/src/types.ts:320](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L320)
...
Defined in: [core/src/types.ts:26](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L26)
...
Defined in: [core/src/types.ts:44](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L44)
...
Defined in: [core/src/types.ts:333](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L333)
...
Defined in: [core/src/types.ts:52](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L52)
...
Defined in: [core/src/types.ts:32](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L32)
...
Defined in: [core/src/types.ts:36](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L36)
...
Defined in: [core/src/types.ts:40](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L40)
...
Defined in: [core/src/types.ts:14](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L14)
...
Defined in: [core/src/types.ts:28](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L28)
...
Defined in: [core/src/types.ts:16](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L16)
...
Defined in: [core/src/types.ts:10](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L10)
...
Defined in: [core/src/types.ts:50](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L50)
...
Defined in: [core/src/types.ts:329](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L329)
...
Defined in: [core/src/types.ts:38](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L38)
...
Defined in: [core/src/types.ts:54](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L54)
...
Defined in: [core/src/types.ts:30](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L30)
...
Defined in: [core/src/types.ts:46](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L46)
...
Defined in: [core/src/types.ts:48](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L48)
...
Defined in: [core/src/types.ts:18](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L18)
...
Defined in: [core/src/types.ts:20](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L20)
...
Defined in: [core/src/types.ts:22](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L22)
...
Defined in: [core/src/types.ts:24](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L24)
...
Defined in: [core/src/types.ts:42](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L42)
...
Defined in: [core/src/types.ts:325](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L325)
...
Defined in: [core/src/types.ts:34](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L34)
...
Defined in: [core/src/types.ts:8](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L8)
...
Defined in: [core/src/types.ts:12](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L12)
...
Defined in: [core/src/types.ts:60](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L60)
...
Defined in: [core/src/types.ts:74](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L74)
...
Defined in: [core/src/types.ts:81](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L81)
...
Defined in: [core/src/types.ts:80](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L80)
...
Defined in: [core/src/types.ts:68](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L68)
...
Defined in: [core/src/types.ts:62](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L62)
...
Defined in: [core/src/types.ts:61](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L61)
...
Defined in: [core/src/types.ts:76](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L76)
...
Defined in: [core/src/types.ts:73](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L73)
...
Defined in: [core/src/types.ts:71](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L71)
...
Defined in: [core/src/types.ts:75](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L75)
...
Defined in: [core/src/types.ts:72](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L72)
...
Defined in: [core/src/types.ts:65](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L65)
...
Defined in: [core/src/types.ts:67](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L67)
...
Defined in: [core/src/types.ts:69](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L69)
...
Defined in: [core/src/types.ts:70](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L70)
...
Defined in: [core/src/types.ts:63](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L63)
...
Defined in: [core/src/types.ts:66](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L66)
...
Defined in: [core/src/types.ts:64](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L64)
...
Defined in: [core/src/types.ts:258](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L258)
...
Defined in: [core/src/types.ts:259](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L259)
...
Defined in: [core/src/types.ts:261](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L261)
...
Defined in: [core/src/types.ts:260](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L260)
...
Defined in: [core/src/types.ts:132](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L132)
...
Defined in: [core/src/types.ts:152](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L152)
...
Defined in: [core/src/types.ts:136](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L136)
...
Defined in: [core/src/types.ts:117](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L117)
...
Defined in: [core/src/types.ts:119](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L119)
...
Defined in: [core/src/types.ts:292](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L292)
...
Defined in: [core/src/types.ts:274](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L274)
...
Defined in: [core/src/types.ts:279](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L279)
...
Defined in: [core/src/types.ts:280](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L280)
...
Defined in: [core/src/types.ts:281](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L281)
...
Defined in: [core/src/types.ts:286](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L286)
...
Defined in: [core/src/types.ts:267](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/core/src/types.ts#L267)
...
Defined in: [devtools/src/WizardDevTools.tsx:11](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/devtools/src/WizardDevTools.tsx#L11)
...
Defined in: [middleware/src/devToolsMiddleware.ts:49](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/middleware/src/devToolsMiddleware.ts#L49)
...
Defined in: [middleware/src/loggerMiddleware.ts:6](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/middleware/src/loggerMiddleware.ts#L6)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:6](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L6)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:9](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L9)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:69](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L69)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:60](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L60)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:27](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L27)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:44](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L44)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:17](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/LocalStorageAdapter.ts#L17)
...
Defined in: [persistence/src/MemoryAdapter.ts:6](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L6)
...
Defined in: [persistence/src/MemoryAdapter.ts:27](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L27)
...
Defined in: [persistence/src/MemoryAdapter.ts:23](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L23)
...
Defined in: [persistence/src/MemoryAdapter.ts:13](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L13)
...
Defined in: [persistence/src/MemoryAdapter.ts:17](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L17)
...
Defined in: [persistence/src/MemoryAdapter.ts:9](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/persistence/src/MemoryAdapter.ts#L9)
...
Defined in: [react/src/context/WizardContext.tsx:61](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L61)
...
Defined in: [react/src/hooks/useWizard.ts:7](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/hooks/useWizard.ts#L7)
...
Defined in: [react/src/context/WizardContext.tsx:689](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L689)
...
Defined in: [react/src/context/WizardContext.tsx:698](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L698)
...
Defined in: [react/src/context/WizardContext.tsx:623](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L623)
...
Defined in: [react/src/context/WizardContext.tsx:776](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L776)
...
Defined in: [react/src/context/WizardContext.tsx:746](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L746)
...
Defined in: [react/src/context/WizardContext.tsx:640](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L640)
...
Defined in: [react/src/context/WizardContext.tsx:552](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L552)
...
Defined in: [react/src/context/WizardContext.tsx:739](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L739)
...
Defined in: [react/src/store.ts:478](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L478)
...
Defined in: [react/src/store.ts:409](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L409)
...
Defined in: [react/src/context/WizardContext.tsx:564](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L564)
...
Defined in: [react/src/store.ts:21](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L21)
...
Defined in: [react/src/store.ts:22](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L22)
...
Defined in: [react/src/store.ts:23](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L23)
...
Defined in: [react/src/store.ts:24](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L24)
...
Defined in: [react/src/types.ts:19](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/types.ts#L19)
...
Defined in: [react/src/types.ts:21](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/types.ts#L21)
...
Defined in: [react/src/types.ts:20](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/types.ts#L20)
`,E9=`[**wizzard-packages**](../../../README.md)
...
Defined in: [react/src/context/WizardContext.tsx:51](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L51)
...
Defined in: [react/src/context/WizardContext.tsx:55](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L55)
...
Defined in: [react/src/context/WizardContext.tsx:52](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L52)
...
Defined in: [react/src/context/WizardContext.tsx:53](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L53)
...
Defined in: [react/src/context/WizardContext.tsx:54](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/context/WizardContext.tsx#L54)
`,D9=`[**wizzard-packages**](../../../README.md)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:7](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/components/WizardStepRenderer.tsx#L7)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:9](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/components/WizardStepRenderer.tsx#L9)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:8](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/components/WizardStepRenderer.tsx#L8)
`,T9=`[**wizzard-packages**](../../../README.md)
...
Defined in: [react/src/store.ts:27](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L27)
...
Defined in: [react/src/store.ts:29](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L29)
...
Defined in: [react/src/store.ts:28](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/store.ts#L28)
`,A9=`[**wizzard-packages**](../../../README.md)
...
Defined in: [react/src/types.ts:32](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/types.ts#L32)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:15](https://github.com/ZizzX/wizzard-packages/blob/d1f3d06b432d2b4209d29030096616493cf28594/packages/react/src/components/WizardStepRenderer.tsx#L15)
...
Simple logger middleware for Wizard actions
`,M9=Object.assign({"../../../../docs/api/README.md":n4,"../../../../docs/api/adapter-yup/src/README.md":t4,"../../../../docs/api/adapter-yup/src/classes/YupAdapter.md":a4,"../../../../docs/api/adapter-yup/src/interfaces/YupLikeError.md":i4,"../../../../docs/api/adapter-yup/src/interfaces/YupLikeSchema.md":r4,"../../../../docs/api/adapter-zod/src/README.md":l4,"../../../../docs/api/adapter-zod/src/classes/ZodAdapter.md":s4,"../../../../docs/api/adapter-zod/src/interfaces/ZodLikeSchema.md":o4,"../../../../docs/api/core/src/README.md":c4,"../../../../docs/api/core/src/classes/WizardStore.md":u4,"../../../../docs/api/core/src/functions/getByPath.md":d4,"../../../../docs/api/core/src/functions/setByPath.md":f4,"../../../../docs/api/core/src/functions/shallowEqual.md":p4,"../../../../docs/api/core/src/functions/toPath.md":h4,"../../../../docs/api/core/src/interfaces/IBreadcrumb.md":m4,"../../../../docs/api/core/src/interfaces/IPersistenceAdapter.md":g4,"../../../../docs/api/core/src/interfaces/IStepConfig.md":y4,"../../../../docs/api/core/src/interfaces/IValidatorAdapter.md":b4,"../../../../docs/api/core/src/interfaces/IWizardActions.md":z4,"../../../../docs/api/core/src/interfaces/IWizardConfig.md":S4,"../../../../docs/api/core/src/interfaces/IWizardContext.md":v4,"../../../../docs/api/core/src/interfaces/IWizardState.md":E4,"../../../../docs/api/core/src/interfaces/IWizardStore.md":x4,"../../../../docs/api/core/src/interfaces/MiddlewareAPI.md":D4,"../../../../docs/api/core/src/type-aliases/BreadcrumbStatus.md":T4,"../../../../docs/api/core/src/type-aliases/Path.md":A4,"../../../../docs/api/core/src/type-aliases/PathValue.md":w4,"../../../../docs/api/core/src/type-aliases/PersistenceMode.md":R4,"../../../../docs/api/core/src/type-aliases/StepDirection.md":k4,"../../../../docs/api/core/src/type-aliases/ValidationMode.md":I4,"../../../../docs/api/core/src/type-aliases/ValidationResult.md":_4,"../../../../docs/api/core/src/type-aliases/WizardAction.md":M4,"../../../../docs/api/core/src/type-aliases/WizardEventHandler.md":C4,"../../../../docs/api/core/src/type-aliases/WizardEventName.md":L4,"../../../../docs/api/core/src/type-aliases/WizardEventPayloads.md":W4,"../../../../docs/api/core/src/type-aliases/WizardMiddleware.md":O4,"../../../../docs/api/devtools/src/README.md":P4,"../../../../docs/api/devtools/src/functions/WizardDevTools.md":N4,"../../../../docs/api/middleware/src/README.md":U4,"../../../../docs/api/middleware/src/variables/devToolsMiddleware.md":j4,"../../../../docs/api/middleware/src/variables/loggerMiddleware.md":B4,"../../../../docs/api/persistence/src/README.md":X4,"../../../../docs/api/persistence/src/classes/LocalStorageAdapter.md":Z4,"../../../../docs/api/persistence/src/classes/MemoryAdapter.md":H4,"../../../../docs/api/react/src/README.md":V4,"../../../../docs/api/react/src/classes/WizardStore.md":q4,"../../../../docs/api/react/src/functions/WizardProvider.md":Y4,"../../../../docs/api/react/src/functions/createWizardFactory.md":G4,"../../../../docs/api/react/src/functions/createWizardHooks.md":Q4,"../../../../docs/api/react/src/functions/createWizardStore.md":F4,"../../../../docs/api/react/src/functions/useWizard.md":K4,"../../../../docs/api/react/src/functions/useWizardActions.md":J4,"../../../../docs/api/react/src/functions/useWizardAllErrors.md":$4,"../../../../docs/api/react/src/functions/useWizardContext.md":e9,"../../../../docs/api/react/src/functions/useWizardCurrentStep.md":n9,"../../../../docs/api/react/src/functions/useWizardError.md":t9,"../../../../docs/api/react/src/functions/useWizardField.md":a9,"../../../../docs/api/react/src/functions/useWizardFlatErrors.md":i9,"../../../../docs/api/react/src/functions/useWizardMeta.md":r9,"../../../../docs/api/react/src/functions/useWizardSelector.md":l9,"../../../../docs/api/react/src/functions/useWizardState.md":s9,"../../../../docs/api/react/src/functions/useWizardSteps.md":o9,"../../../../docs/api/react/src/functions/useWizardStoreError.md":c9,"../../../../docs/api/react/src/functions/useWizardStoreField.md":u9,"../../../../docs/api/react/src/functions/useWizardStoreSelector.md":d9,"../../../../docs/api/react/src/functions/useWizardStoreState.md":f9,"../../../../docs/api/react/src/functions/useWizardStoreValue.md":p9,"../../../../docs/api/react/src/functions/useWizardValue.md":h9,"../../../../docs/api/react/src/interfaces/CreateWizardStoreOptions.md":m9,"../../../../docs/api/react/src/interfaces/IStepConfig.md":g9,"../../../../docs/api/react/src/interfaces/IValidatorAdapter.md":y9,"../../../../docs/api/react/src/interfaces/IWizardActions.md":b9,"../../../../docs/api/react/src/interfaces/IWizardConfig.md":z9,"../../../../docs/api/react/src/interfaces/IWizardContext.md":S9,"../../../../docs/api/react/src/interfaces/IWizardHandle.md":v9,"../../../../docs/api/react/src/interfaces/IWizardState.md":E9,"../../../../docs/api/react/src/interfaces/WizardProviderProps.md":x9,"../../../../docs/api/react/src/interfaces/WizardStepRendererProps.md":D9,"../../../../docs/api/react/src/interfaces/WizardStoreBundle.md":T9,"../../../../docs/api/react/src/type-aliases/IWizardActionsTyped.md":A9,"../../../../docs/api/react/src/type-aliases/PersistenceMode.md":w9,"../../../../docs/api/react/src/type-aliases/ValidationResult.md":R9,"../../../../docs/api/react/src/type-aliases/WizardMiddleware.md":k9,"../../../../docs/api/react/src/variables/WizardStepRenderer.md":I9,"../../../../docs/api/react/src/variables/loggerMiddleware.md":_9}),C9=[/^react\/src\/README$/,/^react\/src\/functions\/(createWizardFactory|useWizard|useWizardActions|useWizardContext|useWizardError|useWizardSelector|useWizardState|useWizardValue|WizardProvider)$/,/^react\/src\/interfaces\/(IWizardConfig|IStepConfig|IWizardState|IWizardActions|IWizardContext|IValidatorAdapter|IWizardHandle|WizardProviderProps|WizardStepRendererProps)$/,/^react\/src\/type-aliases\/(PersistenceMode|ValidationResult|WizardMiddleware)$/,/^react\/src\/variables\/(WizardStepRenderer|loggerMiddleware)$/,/^adapter-zod\/src\/README$/,/^adapter-zod\/src\/classes\/ZodAdapter$/,/^adapter-yup\/src\/README$/,/^adapter-yup\/src\/classes\/YupAdapter$/,/^persistence\/src\/README$/,/^persistence\/src\/classes\/(LocalStorageAdapter|MemoryAdapter)$/,/^middleware\/src\/README$/,/^middleware\/src\/variables\/(loggerMiddleware|devToolsMiddleware)$/,/^devtools\/src\/README$/,/^devtools\/src\/functions\/WizardDevTools$/],L9=a=>C9.some(r=>r.test(a)),W9=Object.entries(M9).map(([a,r])=>{const l=a.replace("../../../../docs/api/","").replace(/\.md$/,""),s=l.split("/").slice(-1)[0].replace(/[-_]/g," ");return{slug:l,title:s,content:String(r),isUserFacing:L9(l)}}),O9=W9.sort((a,r)=>a.slug.localeCompare(r.slug)),eo=O9,xg=a=>a==="README"||a.endsWith("/README"),Ay=a=>a.replace(/\.md$/,"").replace(/\/$/,"")||"README",Nu=new Set(eo.map(a=>a.slug)),Uu=eo.filter(a=>a.isUserFacing),P9=a=>Ay(a.replace(/^\.\//,"").replace(/^\//,""));function N9(){const a=Gz(),r=Uu.find(d=>!xg(d.slug))?.slug||"README",l=Ay(a["*"]||r),s=eo.find(d=>d.slug===l)||Uu[0]||eo[0],u=Uu.filter(d=>!xg(d.slug));return s?Q.jsxs("section",{className:"section api-layout",children:[Q.jsxs("aside",{className:"api-sidebar",children:[Q.jsx("h2",{children:"API Reference"}),Q.jsx("p",{className:"api-note",children:"Generated from TypeDoc. Pick a module to explore the surface area."}),Q.jsx("div",{className:"api-list",children:u.map(d=>Q.jsx(Dl,{to:`/api/${d.slug}`,className:`api-link${d.slug===s.slug?" api-link--active":""}`,children:d.title},d.slug))})]}),Q.jsx("article",{className:"api-content markdown",children:Q.jsx(F3,{components:{a:({href:d,children:f,node:h,...g})=>{if(!d)return Q.jsx("a",{...g,children:f});if(d.startsWith("#"))return Q.jsx("a",{href:d,...g,children:f});if(/^https?:\/\//.test(d))return Q.jsx("a",{href:d,rel:"noreferrer",target:"_blank",...g,children:f});let p=P9(d);return!Nu.has(p)&&Nu.has(`${p}/README`)&&(p=`${p}/README`),Nu.has(p)?Q.jsx(Dl,{to:`/api/${p}`,...g,children:f}):Q.jsx("a",{href:d,...g,children:f})}},children:s.content})})]}):Q.jsx("section",{className:"section api-layout",children:Q.jsxs("article",{className:"api-content",children:[Q.jsx("h2",{children:"API Reference"}),Q.jsxs("p",{children:["API docs are not available. Run ",Q.jsx("code",{children:"pnpm docs:api"})," first."]})]})})}const Qa="https://stackblitz.com/github/ZizzX/wizzard-packages/tree/dev/.stackblitz",U9=[{title:"Validation",description:"Zod/Yup adapters with step-level validation.",href:`${Qa}/validation`},{title:"Persistence",description:"LocalStorage + memory adapters with auto-save.",href:`${Qa}/persistence`},{title:"Navigation",description:"Sequential, visited, and free navigation modes.",href:`${Qa}/basic`},{title:"Custom Adapter",description:"Bring your own validation adapter.",href:`${Qa}/custom-adapter`},{title:"Custom Middleware",description:"Analytics, logging, and guardrails.",href:`${Qa}/middleware`},{title:"Advanced Flow",description:"Branching, guards, and async conditions.",href:`${Qa}/advanced-flow`},{title:"Core Engine",description:"Use @wizzard-packages/core without React bindings.",href:`${Qa}/core-engine`},{title:"Vue + Core",description:"Wire the core engine into a Vue 3 UI.",href:`${Qa}/vue-core`}];function j9(){return Q.jsxs("section",{className:"section",children:[Q.jsxs("div",{className:"section-header",children:[Q.jsx("p",{className:"section-eyebrow",children:"Cookbook"}),Q.jsx("h2",{children:"Examples"}),Q.jsx("p",{className:"section-lead",children:"Start from working recipes and customize the steps for your product."})]}),Q.jsx("div",{className:"card-grid",children:U9.map(a=>Q.jsxs("a",{className:"card card--link",href:a.href,target:"_blank",rel:"noreferrer",children:[Q.jsx("h3",{children:a.title}),Q.jsx("p",{children:a.description}),Q.jsx("span",{className:"card-cta",children:"Open StackBlitz"})]},a.title))})]})}const B9=`import type { IValidatorAdapter, ValidationResult } from '@wizzard-packages/core';
...
`,X9=`import type { WizardMiddleware } from '@wizzard-packages/core';
...
`,Z9=`import type { IPersistenceAdapter } from '@wizzard-packages/core';
...
`;function H9(){return Q.jsxs("section",{className:"section learn-section",children:[Q.jsxs("div",{className:"section-header",children:[Q.jsx("p",{className:"section-eyebrow",children:"Extend"}),Q.jsx("h2",{children:"Build your own adapters, middleware, and persistence"}),Q.jsx("p",{className:"section-lead",children:"Wizzard Stepper is designed for extension. Bring your own validation, tracking, and storage without changing the core engine."})]}),Q.jsxs("div",{className:"learn-grid",children:[Q.jsxs("article",{className:"card learn-panel",children:[Q.jsx("h3",{children:"Custom validation adapter"}),Q.jsxs("p",{children:["Implement ",Q.jsx("code",{children:"IValidatorAdapter"})," to connect any schema or rules engine."]}),Q.jsx("pre",{className:"learn-code",children:Q.jsx("code",{children:B9})})]}),Q.jsxs("article",{className:"card learn-panel",children:[Q.jsx("h3",{children:"Custom middleware"}),Q.jsxs("p",{children:["Implement ",Q.jsx("code",{children:"WizardMiddleware"})," for logging, analytics, or guardrails."]}),Q.jsx("pre",{className:"learn-code",children:Q.jsx("code",{children:X9})})]}),Q.jsxs("article",{className:"card learn-panel",children:[Q.jsx("h3",{children:"Custom persistence"}),Q.jsxs("p",{children:["Implement ",Q.jsx("code",{children:"IPersistenceAdapter"})," to save wizard state to any backend or storage."]}),Q.jsx("pre",{className:"learn-code",children:Q.jsx("code",{children:Z9})})]})]}),Q.jsxs("div",{className:"learn-actions",children:[Q.jsx(Dl,{to:"/examples",className:"button button--primary",children:"Open examples"}),Q.jsx(Dl,{to:"/api",className:"button button--ghost",children:"Browse API"})]})]})}const V9=gS([{path:"/",element:Q.jsx(CS,{}),children:[{index:!0,element:Q.jsx(LS,{})},{path:"api/*",element:Q.jsx(N9,{})},{path:"examples",element:Q.jsx(j9,{})},{path:"learn",element:Q.jsx(H9,{})}]}],{basename:"/wizzard-packages/dev/"});function q9(){return Q.jsx(DS,{router:V9})}const Dg=document.getElementById("root");Dg&&Z0.createRoot(Dg).render(Q.jsx(Ag.StrictMode,{children:Q.jsx(q9,{})}));
