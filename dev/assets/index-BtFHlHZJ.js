...
`});const p={type:"element",tagName:"li",properties:d,children:f};return a.patch(r,p),a.applyData(r,p)}function V0(a){let r=!1;if(a.type==="list"){r=a.spread||!1;const l=a.children;let s=-1;for(;!r&&++s<l.length;)r=zy(l[s])}return r}function zy(a){const r=a.spread;return r??a.children.length>1}function q0(a,r){const l={},s=a.all(r);let u=-1;for(typeof r.start=="number"&&r.start!==1&&(l.start=r.start);++u<s.length;){const f=s[u];if(f.type==="element"&&f.tagName==="li"&&f.properties&&Array.isArray(f.properties.className)&&f.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const d={type:"element",tagName:r.ordered?"ol":"ul",properties:l,children:a.wrap(s,!0)};return a.patch(r,d),a.applyData(r,d)}function Y0(a,r){const l={type:"element",tagName:"p",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}function G0(a,r){const l={type:"root",children:a.wrap(a.all(r))};return a.patch(r,l),a.applyData(r,l)}function Q0(a,r){const l={type:"element",tagName:"strong",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}function K0(a,r){const l=a.all(r),s=l.shift(),u=[];if(s){const f={type:"element",tagName:"thead",properties:{},children:a.wrap([s],!0)};a.patch(r.children[0],f),u.push(f)}if(l.length>0){const f={type:"element",tagName:"tbody",properties:{},children:a.wrap(l,!0)},h=ud(r.children[1]),g=Jg(r.children[r.children.length-1]);h&&g&&(f.position={start:h,end:g}),u.push(f)}const d={type:"element",tagName:"table",properties:{},children:a.wrap(u,!0)};return a.patch(r,d),a.applyData(r,d)}function F0(a,r,l){const s=l?l.children:void 0,d=(s?s.indexOf(r):1)===0?"th":"td",f=l&&l.type==="table"?l.align:void 0,h=f?f.length:r.children.length;let g=-1;const p=[];for(;++g<h;){const z=r.children[g],S={},v=f?f[g]:void 0;v&&(S.align=v);let L={type:"element",tagName:d,properties:S,children:[]};z&&(L.children=a.all(z),a.patch(z,L),L=a.applyData(z,L)),p.push(L)}const y={type:"element",tagName:"tr",properties:{},children:a.wrap(p,!0)};return a.patch(r,y),a.applyData(r,y)}function J0(a,r){const l={type:"element",tagName:"td",properties:{},children:a.all(r)};return a.patch(r,l),a.applyData(r,l)}const sg=9,og=32;function $0(a){const r=String(a),l=/\r?\n|\r/g;let s=l.exec(r),u=0;const d=[];for(;s;)d.push(cg(r.slice(u,s.index),u>0,!0),s[0]),u=s.index+s[0].length,s=l.exec(r);return d.push(cg(r.slice(u),u>0,!1)),d.join("")}function cg(a,r,l){let s=0,u=a.length;if(r){let d=a.codePointAt(s);for(;d===sg||d===og;)s++,d=a.codePointAt(s)}if(l){let d=a.codePointAt(u-1);for(;d===sg||d===og;)u--,d=a.codePointAt(u-1)}return u>s?a.slice(s,u):""}function eE(a,r){const l={type:"text",value:$0(String(r.value))};return a.patch(r,l),a.applyData(r,l)}function nE(a,r){const l={type:"element",tagName:"hr",properties:{},children:[]};return a.patch(r,l),a.applyData(r,l)}const tE={blockquote:I0,break:_0,code:C0,delete:L0,emphasis:O0,footnoteReference:N0,heading:W0,html:U0,imageReference:P0,image:j0,inlineCode:B0,linkReference:X0,link:H0,listItem:Z0,list:q0,paragraph:Y0,root:G0,strong:Q0,table:K0,tableCell:J0,tableRow:F0,text:eE,thematicBreak:nE,toml:Bs,yaml:Bs,definition:Bs,footnoteDefinition:Bs};function Bs(){}const by=-1,to=0,vl=1,Ks=2,yd=3,zd=4,bd=5,vd=6,vy=7,Sy=8,ug=typeof self=="object"?self:globalThis,aE=(a,r)=>{const l=(u,d)=>(a.set(d,u),u),s=u=>{if(a.has(u))return a.get(u);const[d,f]=r[u];switch(d){case to:case by:return l(f,u);case vl:{const h=l([],u);for(const g of f)h.push(s(g));return h}case Ks:{const h=l({},u);for(const[g,p]of f)h[s(g)]=s(p);return h}case yd:return l(new Date(f),u);case zd:{const{source:h,flags:g}=f;return l(new RegExp(h,g),u)}case bd:{const h=l(new Map,u);for(const[g,p]of f)h.set(s(g),s(p));return h}case vd:{const h=l(new Set,u);for(const g of f)h.add(s(g));return h}case vy:{const{name:h,message:g}=f;return l(new ug[h](g),u)}case Sy:return l(BigInt(f),u);case"BigInt":return l(Object(BigInt(f)),u);case"ArrayBuffer":return l(new Uint8Array(f).buffer,f);case"DataView":{const{buffer:h}=new Uint8Array(f);return l(new DataView(h),f)}}return l(new ug[d](f),u)};return s},dg=a=>aE(new Map,a)(0),pr="",{toString:iE}={},{keys:rE}=Object,gl=a=>{const r=typeof a;if(r!=="object"||!a)return[to,r];const l=iE.call(a).slice(8,-1);switch(l){case"Array":return[vl,pr];case"Object":return[Ks,pr];case"Date":return[yd,pr];case"RegExp":return[zd,pr];case"Map":return[bd,pr];case"Set":return[vd,pr];case"DataView":return[vl,l]}return l.includes("Array")?[vl,l]:l.includes("Error")?[vy,l]:[Ks,l]},Xs=([a,r])=>a===to&&(r==="function"||r==="symbol"),lE=(a,r,l,s)=>{const u=(f,h)=>{const g=s.push(f)-1;return l.set(h,g),g},d=f=>{if(l.has(f))return l.get(f);let[h,g]=gl(f);switch(h){case to:{let y=f;switch(g){case"bigint":h=Sy,y=f.toString();break;case"function":case"symbol":if(a)throw new TypeError("unable to serialize "+g);y=null;break;case"undefined":return u([by],f)}return u([h,y],f)}case vl:{if(g){let S=f;return g==="DataView"?S=new Uint8Array(f.buffer):g==="ArrayBuffer"&&(S=new Uint8Array(f)),u([g,[...S]],f)}const y=[],z=u([h,y],f);for(const S of f)y.push(d(S));return z}case Ks:{if(g)switch(g){case"BigInt":return u([g,f.toString()],f);case"Boolean":case"Number":case"String":return u([g,f.valueOf()],f)}if(r&&"toJSON"in f)return d(f.toJSON());const y=[],z=u([h,y],f);for(const S of rE(f))(a||!Xs(gl(f[S])))&&y.push([d(S),d(f[S])]);return z}case yd:return u([h,f.toISOString()],f);case zd:{const{source:y,flags:z}=f;return u([h,{source:y,flags:z}],f)}case bd:{const y=[],z=u([h,y],f);for(const[S,v]of f)(a||!(Xs(gl(S))||Xs(gl(v))))&&y.push([d(S),d(v)]);return z}case vd:{const y=[],z=u([h,y],f);for(const S of f)(a||!Xs(gl(S)))&&y.push(d(S));return z}}const{message:p}=f;return u([h,{name:g,message:p}],f)};return d},fg=(a,{json:r,lossy:l}={})=>{const s=[];return lE(!(r||l),!!r,new Map,s)(a),s},Fs=typeof structuredClone=="function"?(a,r)=>r&&("json"in r||"lossy"in r)?dg(fg(a,r)):structuredClone(a):(a,r)=>dg(fg(a,r));function sE(a,r){const l=[{type:"text",value:"↩"}];return r>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(r)}]}),l}function oE(a,r){return"Back to reference "+(a+1)+(r>1?"-"+r:"")}function cE(a){const r=typeof a.options.clobberPrefix=="string"?a.options.clobberPrefix:"user-content-",l=a.options.footnoteBackContent||sE,s=a.options.footnoteBackLabel||oE,u=a.options.footnoteLabel||"Footnotes",d=a.options.footnoteLabelTagName||"h2",f=a.options.footnoteLabelProperties||{className:["sr-only"]},h=[];let g=-1;for(;++g<a.footnoteOrder.length;){const p=a.footnoteById.get(a.footnoteOrder[g]);if(!p)continue;const y=a.all(p),z=String(p.identifier).toUpperCase(),S=zr(z.toLowerCase());let v=0;const L=[],N=a.footnoteCounts.get(z);for(;N!==void 0&&++v<=N;){L.length>0&&L.push({type:"text",value:" "});let G=typeof l=="string"?l:l(g,v);typeof G=="string"&&(G={type:"text",value:G}),L.push({type:"element",tagName:"a",properties:{href:"#"+r+"fnref-"+S+(v>1?"-"+v:""),dataFootnoteBackref:"",ariaLabel:typeof s=="string"?s:s(g,v),className:["data-footnote-backref"]},children:Array.isArray(G)?G:[G]})}const H=y[y.length-1];if(H&&H.type==="element"&&H.tagName==="p"){const G=H.children[H.children.length-1];G&&G.type==="text"?G.value+=" ":H.children.push({type:"text",value:" "}),H.children.push(...L)}else y.push(...L);const P={type:"element",tagName:"li",properties:{id:r+"fn-"+S},children:a.wrap(y,!0)};a.patch(p,P),h.push(P)}if(h.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:d,properties:{...Fs(f),id:"footnote-label"},children:[{type:"text",value:u}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:a.wrap(h,!0)},{type:"text",value:`
`}]}}const Ey=(function(a){if(a==null)return pE;if(typeof a=="function")return ao(a);if(typeof a=="object")return Array.isArray(a)?uE(a):dE(a);if(typeof a=="string")return fE(a);throw new Error("Expected function, string, or object as test")});function uE(a){const r=[];let l=-1;for(;++l<a.length;)r[l]=Ey(a[l]);return ao(s);function s(...u){let d=-1;for(;++d<r.length;)if(r[d].apply(this,u))return!0;return!1}}function dE(a){const r=a;return ao(l);function l(s){const u=s;let d;for(d in a)if(u[d]!==r[d])return!1;return!0}}function fE(a){return ao(r);function r(l){return l&&l.type===a}}function ao(a){return r;function r(l,s,u){return!!(hE(l)&&a.call(this,l,typeof s=="number"?s:void 0,u||void 0))}}function pE(){return!0}function hE(a){return a!==null&&typeof a=="object"&&"type"in a}const xy=[],mE=!0,pg=!1,gE="skip";function yE(a,r,l,s){let u;typeof r=="function"&&typeof l!="function"?(s=l,l=r):u=r;const d=Ey(u),f=s?-1:1;h(a,void 0,[])();function h(g,p,y){const z=g&&typeof g=="object"?g:{};if(typeof z.type=="string"){const v=typeof z.tagName=="string"?z.tagName:typeof z.name=="string"?z.name:void 0;Object.defineProperty(S,"name",{value:"node ("+(g.type+(v?"<"+v+">":""))+")"})}return S;function S(){let v=xy,L,N,H;if((!r||d(g,p,y[y.length-1]||void 0))&&(v=zE(l(g,y)),v[0]===pg))return v;if("children"in g&&g.children){const P=g;if(P.children&&v[0]!==gE)for(N=(s?P.children.length:-1)+f,H=y.concat(P);N>-1&&N<P.children.length;){const G=P.children[N];if(L=h(G,N,H)(),L[0]===pg)return L;N=typeof L[1]=="number"?L[1]:N+f}}return v}}}function zE(a){return Array.isArray(a)?a:typeof a=="number"?[mE,a]:a==null?xy:[a]}function Dy(a,r,l,s){let u,d,f;typeof r=="function"&&typeof l!="function"?(d=void 0,f=r,u=l):(d=r,f=l,u=s),yE(a,d,h,u);function h(g,p){const y=p[p.length-1],z=y?y.children.indexOf(g):void 0;return f(g,z,y)}}const Fu={}.hasOwnProperty,bE={};function vE(a,r){const l=r||bE,s=new Map,u=new Map,d=new Map,f={...tE,...l.handlers},h={all:p,applyData:EE,definitionById:s,footnoteById:u,footnoteCounts:d,footnoteOrder:[],handlers:f,one:g,options:l,patch:SE,wrap:DE};return Dy(a,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const z=y.type==="definition"?s:u,S=String(y.identifier).toUpperCase();z.has(S)||z.set(S,y)}}),h;function g(y,z){const S=y.type,v=h.handlers[S];if(Fu.call(h.handlers,S)&&v)return v(h,y,z);if(h.options.passThrough&&h.options.passThrough.includes(S)){if("children"in y){const{children:N,...H}=y,P=Fs(H);return P.children=h.all(y),P}return Fs(y)}return(h.options.unknownHandler||xE)(h,y,z)}function p(y){const z=[];if("children"in y){const S=y.children;let v=-1;for(;++v<S.length;){const L=h.one(S[v],y);if(L){if(v&&S[v-1].type==="break"&&(!Array.isArray(L)&&L.type==="text"&&(L.value=hg(L.value)),!Array.isArray(L)&&L.type==="element")){const N=L.children[0];N&&N.type==="text"&&(N.value=hg(N.value))}Array.isArray(L)?z.push(...L):z.push(L)}}}return z}}function SE(a,r){a.position&&(r.position=i1(a))}function EE(a,r){let l=r;if(a&&a.data){const s=a.data.hName,u=a.data.hChildren,d=a.data.hProperties;if(typeof s=="string")if(l.type==="element")l.tagName=s;else{const f="children"in l?l.children:[l];l={type:"element",tagName:s,properties:{},children:f}}l.type==="element"&&d&&Object.assign(l.properties,Fs(d)),"children"in l&&l.children&&u!==null&&u!==void 0&&(l.children=u)}return l}function xE(a,r){const l=r.data||{},s="value"in r&&!(Fu.call(l,"hProperties")||Fu.call(l,"hChildren"))?{type:"text",value:r.value}:{type:"element",tagName:"div",properties:{},children:a.all(r)};return a.patch(r,s),a.applyData(r,s)}function DE(a,r){const l=[];let s=-1;for(r&&l.push({type:"text",value:`
...
Defined in: [adapter-yup/src/YupAdapter.ts:7](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/YupAdapter.ts#L7)
...
Defined in: [adapter-yup/src/YupAdapter.ts:10](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/YupAdapter.ts#L10)
...
Defined in: [adapter-yup/src/YupAdapter.ts:14](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/YupAdapter.ts#L14)
...
Defined in: [adapter-yup/src/types.ts:11](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/types.ts#L11)
...
Defined in: [adapter-yup/src/types.ts:12](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/types.ts#L12)
...
Defined in: [adapter-yup/src/types.ts:4](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/types.ts#L4)
...
Defined in: [adapter-yup/src/types.ts:5](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-yup/src/types.ts#L5)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:7](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-zod/src/ZodAdapter.ts#L7)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:10](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-zod/src/ZodAdapter.ts#L10)
...
Defined in: [adapter-zod/src/ZodAdapter.ts:14](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-zod/src/ZodAdapter.ts#L14)
...
[\`IValidatorAdapter\`](../../../react/src/interfaces/IValidatorAdapter.md).[\`validate\`](../../../react/src/interfaces/IValidatorAdapter.md#validate)
`,o8="[**wizzard-packages**](../../../README.md)\n\n***\n\n[wizzard-packages](../../../README.md) / [adapter-zod/src](../README.md) / ZodLikeSchema\n\n# Interface: ZodLikeSchema\\<T\\>\n\nDefined in: [adapter-zod/src/types.ts:4](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-zod/src/types.ts#L4)\n\nMinimal structural interface for Zod-like schemas.\n\n## Type Parameters\n\n### T\n\n`T` = `any`\n\n## Properties\n\n### safeParseAsync()\n\n> **safeParseAsync**: (`data`) => `Promise`\\<\\{ `data?`: `T`; `error?`: \\{ `issues`: `object`[]; \\}; `success`: `boolean`; \\}\\>\n\nDefined in: [adapter-zod/src/types.ts:5](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/adapter-zod/src/types.ts#L5)\n\n#### Parameters\n\n##### data\n\n`T`\n\n#### Returns\n\n`Promise`\\<\\{ `data?`: `T`; `error?`: \\{ `issues`: `object`[]; \\}; `success`: `boolean`; \\}\\>\n",c8=`[**wizzard-packages**](../../README.md)
...
Defined in: [core/src/store/WizardStore.ts:17](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L17)
...
Defined in: [core/src/store/WizardStore.ts:38](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L38)
...
Defined in: [core/src/store/WizardStore.ts:23](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L23)
...
Defined in: [core/src/store/WizardStore.ts:534](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L534)
...
Defined in: [core/src/store/WizardStore.ts:439](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L439)
...
Defined in: [core/src/store/WizardStore.ts:97](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L97)
...
Defined in: [core/src/store/WizardStore.ts:285](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L285)
...
Defined in: [core/src/store/WizardStore.ts:775](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L775)
...
Defined in: [core/src/store/WizardStore.ts:471](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L471)
...
Defined in: [core/src/store/WizardStore.ts:463](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L463)
...
Defined in: [core/src/store/WizardStore.ts:616](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L616)
...
Defined in: [core/src/store/WizardStore.ts:547](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L547)
...
Defined in: [core/src/store/WizardStore.ts:377](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L377)
...
Defined in: [core/src/store/WizardStore.ts:419](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L419)
...
Defined in: [core/src/store/WizardStore.ts:458](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L458)
...
Defined in: [core/src/store/WizardStore.ts:29](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L29)
...
Defined in: [core/src/store/WizardStore.ts:296](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L296)
...
Defined in: [core/src/store/WizardStore.ts:406](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L406)
...
Defined in: [core/src/store/WizardStore.ts:330](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L330)
...
Defined in: [core/src/store/WizardStore.ts:751](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L751)
...
Defined in: [core/src/store/WizardStore.ts:692](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/store/WizardStore.ts#L692)
...
Defined in: [core/src/utils/data.ts:32](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/utils/data.ts#L32)
...
Defined in: [core/src/utils/data.ts:54](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/utils/data.ts#L54)
...
Defined in: [core/src/utils/data.ts:99](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/utils/data.ts#L99)
...
Defined in: [core/src/utils/data.ts:9](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/utils/data.ts#L9)
...
Defined in: [core/src/types.ts:311](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L311)
...
Defined in: [core/src/types.ts:312](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L312)
...
Defined in: [core/src/types.ts:313](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L313)
...
Defined in: [core/src/types.ts:314](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L314)
`,g8=`[**wizzard-packages**](../../../README.md)
...
Defined in: [core/src/types.ts:141](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L141)
...
Defined in: [core/src/types.ts:146](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L146)
...
Defined in: [core/src/types.ts:145](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L145)
...
Defined in: [core/src/types.ts:143](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L143)
...
Defined in: [core/src/types.ts:144](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L144)
...
Defined in: [core/src/types.ts:142](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L142)
...
Defined in: [core/src/types.ts:157](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L157)
...
Defined in: [core/src/types.ts:179](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L179)
...
Defined in: [core/src/types.ts:169](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L169)
...
Defined in: [core/src/types.ts:189](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L189)
...
Defined in: [core/src/types.ts:185](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L185)
...
Defined in: [core/src/types.ts:181](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L181)
...
Defined in: [core/src/types.ts:160](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L160)
...
Defined in: [core/src/types.ts:168](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L168)
...
Defined in: [core/src/types.ts:184](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L184)
...
Defined in: [core/src/types.ts:158](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L158)
...
Defined in: [core/src/types.ts:159](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L159)
...
Defined in: [core/src/types.ts:182](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L182)
...
Defined in: [core/src/types.ts:183](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L183)
...
Defined in: [core/src/types.ts:167](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L167)
...
Defined in: [core/src/types.ts:177](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L177)
...
Defined in: [core/src/types.ts:180](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L180)
`,z8=`[**wizzard-packages**](../../../README.md)
...
Defined in: [core/src/types.ts:125](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L125)
...
Defined in: [core/src/types.ts:126](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L126)
...
Defined in: [core/src/types.ts:90](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L90)
...
Defined in: [core/src/types.ts:106](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L106)
...
Defined in: [core/src/types.ts:110](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L110)
...
Defined in: [core/src/types.ts:91](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L91)
...
Defined in: [core/src/types.ts:92](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L92)
...
Defined in: [core/src/types.ts:93](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L93)
...
Defined in: [core/src/types.ts:99](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L99)
...
Defined in: [core/src/types.ts:107](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L107)
...
Defined in: [core/src/types.ts:105](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L105)
...
Defined in: [core/src/types.ts:108](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L108)
...
Defined in: [core/src/types.ts:98](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L98)
...
Defined in: [core/src/types.ts:111](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L111)
...
Defined in: [core/src/types.ts:109](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L109)
...
Defined in: [core/src/types.ts:101](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L101)
...
Defined in: [core/src/types.ts:100](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L100)
...
Defined in: [core/src/types.ts:201](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L201)
...
Defined in: [core/src/types.ts:214](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L214)
...
Defined in: [core/src/types.ts:204](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L204)
...
Defined in: [core/src/types.ts:217](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L217)
...
Defined in: [core/src/types.ts:218](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L218)
...
Defined in: [core/src/types.ts:213](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L213)
...
Defined in: [core/src/types.ts:219](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L219)
...
Defined in: [core/src/types.ts:207](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L207)
...
Defined in: [core/src/types.ts:202](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L202)
...
Defined in: [core/src/types.ts:206](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L206)
...
Defined in: [core/src/types.ts:205](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L205)
`,S8=`[**wizzard-packages**](../../../README.md)
...
Defined in: [core/src/types.ts:320](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L320)
...
Defined in: [core/src/types.ts:26](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L26)
...
Defined in: [core/src/types.ts:44](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L44)
...
Defined in: [core/src/types.ts:333](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L333)
...
Defined in: [core/src/types.ts:52](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L52)
...
Defined in: [core/src/types.ts:32](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L32)
...
Defined in: [core/src/types.ts:36](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L36)
...
Defined in: [core/src/types.ts:40](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L40)
...
Defined in: [core/src/types.ts:14](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L14)
...
Defined in: [core/src/types.ts:28](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L28)
...
Defined in: [core/src/types.ts:16](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L16)
...
Defined in: [core/src/types.ts:10](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L10)
...
Defined in: [core/src/types.ts:50](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L50)
...
Defined in: [core/src/types.ts:329](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L329)
...
Defined in: [core/src/types.ts:38](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L38)
...
Defined in: [core/src/types.ts:54](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L54)
...
Defined in: [core/src/types.ts:30](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L30)
...
Defined in: [core/src/types.ts:46](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L46)
...
Defined in: [core/src/types.ts:48](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L48)
...
Defined in: [core/src/types.ts:18](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L18)
...
Defined in: [core/src/types.ts:20](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L20)
...
Defined in: [core/src/types.ts:22](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L22)
...
Defined in: [core/src/types.ts:24](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L24)
...
Defined in: [core/src/types.ts:42](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L42)
...
Defined in: [core/src/types.ts:325](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L325)
...
Defined in: [core/src/types.ts:34](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L34)
...
Defined in: [core/src/types.ts:8](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L8)
...
Defined in: [core/src/types.ts:12](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L12)
...
Defined in: [core/src/types.ts:60](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L60)
...
Defined in: [core/src/types.ts:74](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L74)
...
Defined in: [core/src/types.ts:81](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L81)
...
Defined in: [core/src/types.ts:80](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L80)
...
Defined in: [core/src/types.ts:68](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L68)
...
Defined in: [core/src/types.ts:62](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L62)
...
Defined in: [core/src/types.ts:61](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L61)
...
Defined in: [core/src/types.ts:76](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L76)
...
Defined in: [core/src/types.ts:73](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L73)
...
Defined in: [core/src/types.ts:71](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L71)
...
Defined in: [core/src/types.ts:75](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L75)
...
Defined in: [core/src/types.ts:72](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L72)
...
Defined in: [core/src/types.ts:65](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L65)
...
Defined in: [core/src/types.ts:67](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L67)
...
Defined in: [core/src/types.ts:69](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L69)
...
Defined in: [core/src/types.ts:70](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L70)
...
Defined in: [core/src/types.ts:63](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L63)
...
Defined in: [core/src/types.ts:66](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L66)
...
Defined in: [core/src/types.ts:64](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L64)
...
Defined in: [core/src/types.ts:258](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L258)
...
Defined in: [core/src/types.ts:259](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L259)
...
Defined in: [core/src/types.ts:261](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L261)
...
Defined in: [core/src/types.ts:260](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L260)
...
Defined in: [core/src/types.ts:132](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L132)

Persistence strategy for step data.
`,k8=`[**wizzard-packages**](../../../README.md)
...
Defined in: [core/src/types.ts:152](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L152)
...
Defined in: [core/src/types.ts:136](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L136)
...
Defined in: [core/src/types.ts:117](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L117)
...
Defined in: [core/src/types.ts:119](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L119)
...
Defined in: [core/src/types.ts:292](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L292)
...
Defined in: [core/src/types.ts:274](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L274)
...
Defined in: [core/src/types.ts:279](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L279)
...
Defined in: [core/src/types.ts:280](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L280)
...
Defined in: [core/src/types.ts:281](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L281)
...
Defined in: [core/src/types.ts:286](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L286)
...
Defined in: [core/src/types.ts:267](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/core/src/types.ts#L267)
...
Defined in: [devtools/src/WizardDevTools.tsx:11](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/devtools/src/WizardDevTools.tsx#L11)
...
Defined in: [middleware/src/devToolsMiddleware.ts:49](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/middleware/src/devToolsMiddleware.ts#L49)
...
Defined in: [middleware/src/loggerMiddleware.ts:6](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/middleware/src/loggerMiddleware.ts#L6)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:6](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L6)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:9](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L9)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:69](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L69)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:60](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L60)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:27](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L27)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:44](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L44)
...
Defined in: [persistence/src/LocalStorageAdapter.ts:17](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/LocalStorageAdapter.ts#L17)
...
Defined in: [persistence/src/MemoryAdapter.ts:6](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L6)
...
Defined in: [persistence/src/MemoryAdapter.ts:27](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L27)
...
Defined in: [persistence/src/MemoryAdapter.ts:23](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L23)
...
Defined in: [persistence/src/MemoryAdapter.ts:13](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L13)
...
Defined in: [persistence/src/MemoryAdapter.ts:17](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L17)
...
Defined in: [persistence/src/MemoryAdapter.ts:9](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/persistence/src/MemoryAdapter.ts#L9)
...
Defined in: [react/src/context/WizardContext.tsx:44](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L44)
...
Defined in: [react/src/factory.tsx:21](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/factory.tsx#L21)
...
Defined in: [react/src/hooks/useWizard.ts:7](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/hooks/useWizard.ts#L7)
...
Defined in: [react/src/context/WizardContext.tsx:679](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L679)
...
Defined in: [react/src/context/WizardContext.tsx:688](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L688)
...
Defined in: [react/src/context/WizardContext.tsx:632](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L632)
...
Defined in: [react/src/context/WizardContext.tsx:649](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L649)
...
Defined in: [react/src/context/WizardContext.tsx:591](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L591)
...
Defined in: [react/src/context/WizardContext.tsx:603](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L603)
...
Defined in: [react/src/types.ts:17](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/types.ts#L17)
...
Defined in: [react/src/types.ts:19](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/types.ts#L19)
...
Defined in: [react/src/types.ts:18](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/types.ts#L18)
...
Defined in: [react/src/context/WizardContext.tsx:34](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L34)
...
Defined in: [react/src/context/WizardContext.tsx:38](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L38)
...
Defined in: [react/src/context/WizardContext.tsx:35](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L35)
...
Defined in: [react/src/context/WizardContext.tsx:36](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L36)
...
Defined in: [react/src/context/WizardContext.tsx:37](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/context/WizardContext.tsx#L37)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:7](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/components/WizardStepRenderer.tsx#L7)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:9](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/components/WizardStepRenderer.tsx#L9)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:8](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/components/WizardStepRenderer.tsx#L8)
...
Defined in: [react/src/components/WizardStepRenderer.tsx:15](https://github.com/ZizzX/wizzard-packages/blob/e67a6c134fc66dd79878c594dde551fd6926e088/packages/react/src/components/WizardStepRenderer.tsx#L15)
...
Simple logger middleware for Wizard actions
`,gx=Object.assign({"../../../../docs/api/README.md":n8,"../../../../docs/api/adapter-yup/src/README.md":t8,"../../../../docs/api/adapter-yup/src/classes/YupAdapter.md":a8,"../../../../docs/api/adapter-yup/src/interfaces/YupLikeError.md":i8,"../../../../docs/api/adapter-yup/src/interfaces/YupLikeSchema.md":r8,"../../../../docs/api/adapter-zod/src/README.md":l8,"../../../../docs/api/adapter-zod/src/classes/ZodAdapter.md":s8,"../../../../docs/api/adapter-zod/src/interfaces/ZodLikeSchema.md":o8,"../../../../docs/api/core/src/README.md":c8,"../../../../docs/api/core/src/classes/WizardStore.md":u8,"../../../../docs/api/core/src/functions/getByPath.md":d8,"../../../../docs/api/core/src/functions/setByPath.md":f8,"../../../../docs/api/core/src/functions/shallowEqual.md":p8,"../../../../docs/api/core/src/functions/toPath.md":h8,"../../../../docs/api/core/src/interfaces/IBreadcrumb.md":m8,"../../../../docs/api/core/src/interfaces/IPersistenceAdapter.md":g8,"../../../../docs/api/core/src/interfaces/IStepConfig.md":y8,"../../../../docs/api/core/src/interfaces/IValidatorAdapter.md":z8,"../../../../docs/api/core/src/interfaces/IWizardActions.md":b8,"../../../../docs/api/core/src/interfaces/IWizardConfig.md":v8,"../../../../docs/api/core/src/interfaces/IWizardContext.md":S8,"../../../../docs/api/core/src/interfaces/IWizardState.md":E8,"../../../../docs/api/core/src/interfaces/IWizardStore.md":x8,"../../../../docs/api/core/src/interfaces/MiddlewareAPI.md":D8,"../../../../docs/api/core/src/type-aliases/BreadcrumbStatus.md":T8,"../../../../docs/api/core/src/type-aliases/Path.md":A8,"../../../../docs/api/core/src/type-aliases/PathValue.md":w8,"../../../../docs/api/core/src/type-aliases/PersistenceMode.md":R8,"../../../../docs/api/core/src/type-aliases/StepDirection.md":k8,"../../../../docs/api/core/src/type-aliases/ValidationMode.md":M8,"../../../../docs/api/core/src/type-aliases/ValidationResult.md":I8,"../../../../docs/api/core/src/type-aliases/WizardAction.md":_8,"../../../../docs/api/core/src/type-aliases/WizardEventHandler.md":C8,"../../../../docs/api/core/src/type-aliases/WizardEventName.md":L8,"../../../../docs/api/core/src/type-aliases/WizardEventPayloads.md":O8,"../../../../docs/api/core/src/type-aliases/WizardMiddleware.md":N8,"../../../../docs/api/devtools/src/README.md":W8,"../../../../docs/api/devtools/src/functions/WizardDevTools.md":U8,"../../../../docs/api/middleware/src/README.md":P8,"../../../../docs/api/middleware/src/variables/devToolsMiddleware.md":j8,"../../../../docs/api/middleware/src/variables/loggerMiddleware.md":B8,"../../../../docs/api/persistence/src/README.md":X8,"../../../../docs/api/persistence/src/classes/LocalStorageAdapter.md":H8,"../../../../docs/api/persistence/src/classes/MemoryAdapter.md":Z8,"../../../../docs/api/react/src/README.md":V8,"../../../../docs/api/react/src/classes/WizardStore.md":q8,"../../../../docs/api/react/src/functions/WizardProvider.md":Y8,"../../../../docs/api/react/src/functions/createWizardFactory.md":G8,"../../../../docs/api/react/src/functions/useWizard.md":Q8,"../../../../docs/api/react/src/functions/useWizardActions.md":K8,"../../../../docs/api/react/src/functions/useWizardContext.md":F8,"../../../../docs/api/react/src/functions/useWizardError.md":J8,"../../../../docs/api/react/src/functions/useWizardSelector.md":$8,"../../../../docs/api/react/src/functions/useWizardState.md":ex,"../../../../docs/api/react/src/functions/useWizardValue.md":nx,"../../../../docs/api/react/src/interfaces/IStepConfig.md":tx,"../../../../docs/api/react/src/interfaces/IValidatorAdapter.md":ax,"../../../../docs/api/react/src/interfaces/IWizardActions.md":ix,"../../../../docs/api/react/src/interfaces/IWizardConfig.md":rx,"../../../../docs/api/react/src/interfaces/IWizardContext.md":lx,"../../../../docs/api/react/src/interfaces/IWizardHandle.md":sx,"../../../../docs/api/react/src/interfaces/IWizardState.md":ox,"../../../../docs/api/react/src/interfaces/WizardProviderProps.md":cx,"../../../../docs/api/react/src/interfaces/WizardStepRendererProps.md":ux,"../../../../docs/api/react/src/type-aliases/PersistenceMode.md":dx,"../../../../docs/api/react/src/type-aliases/ValidationResult.md":fx,"../../../../docs/api/react/src/type-aliases/WizardMiddleware.md":px,"../../../../docs/api/react/src/variables/WizardStepRenderer.md":hx,"../../../../docs/api/react/src/variables/loggerMiddleware.md":mx}),yx=[/^react\/src\/README$/,/^react\/src\/functions\/(createWizardFactory|useWizard|useWizardActions|useWizardContext|useWizardError|useWizardSelector|useWizardState|useWizardValue|WizardProvider)$/,/^react\/src\/interfaces\/(IWizardConfig|IStepConfig|IWizardState|IWizardActions|IWizardContext|IValidatorAdapter|IWizardHandle|WizardProviderProps|WizardStepRendererProps)$/,/^react\/src\/type-aliases\/(PersistenceMode|ValidationResult|WizardMiddleware)$/,/^react\/src\/variables\/(WizardStepRenderer|loggerMiddleware)$/,/^adapter-zod\/src\/README$/,/^adapter-zod\/src\/classes\/ZodAdapter$/,/^adapter-yup\/src\/README$/,/^adapter-yup\/src\/classes\/YupAdapter$/,/^persistence\/src\/README$/,/^persistence\/src\/classes\/(LocalStorageAdapter|MemoryAdapter)$/,/^middleware\/src\/README$/,/^middleware\/src\/variables\/(loggerMiddleware|devToolsMiddleware)$/,/^devtools\/src\/README$/,/^devtools\/src\/functions\/WizardDevTools$/],zx=a=>yx.some(r=>r.test(a)),bx=Object.entries(gx).map(([a,r])=>{const l=a.replace("../../../../docs/api/","").replace(/\.md$/,""),s=l.split("/").slice(-1)[0].replace(/[-_]/g," ");return{slug:l,title:s,content:String(r),isUserFacing:zx(l)}}),vx=bx.sort((a,r)=>a.slug.localeCompare(r.slug)),Js=vx,xg=a=>a==="README"||a.endsWith("/README"),Ay=a=>a.replace(/\.md$/,"").replace(/\/$/,"")||"README",Nu=new Set(Js.map(a=>a.slug)),Wu=Js.filter(a=>a.isUserFacing),Sx=a=>Ay(a.replace(/^\.\//,"").replace(/^\//,""));function Ex(){const a=Gv(),r=Wu.find(d=>!xg(d.slug))?.slug||"README",l=Ay(a["*"]||r),s=Js.find(d=>d.slug===l)||Wu[0]||Js[0],u=Wu.filter(d=>!xg(d.slug));return s?re.jsxs("section",{className:"section api-layout",children:[re.jsxs("aside",{className:"api-sidebar",children:[re.jsx("h2",{children:"API Reference"}),re.jsx("p",{className:"api-note",children:"Generated from TypeDoc. Pick a module to explore the surface area."}),re.jsx("div",{className:"api-list",children:u.map(d=>re.jsx(Xu,{to:`/api/${d.slug}`,className:`api-link${d.slug===s.slug?" api-link--active":""}`,children:d.title},d.slug))})]}),re.jsx("article",{className:"api-content markdown",children:re.jsx(KE,{components:{a:({href:d,children:f,node:h,...g})=>{if(!d)return re.jsx("a",{...g,children:f});if(d.startsWith("#"))return re.jsx("a",{href:d,...g,children:f});if(/^https?:\/\//.test(d))return re.jsx("a",{href:d,rel:"noreferrer",target:"_blank",...g,children:f});let p=Sx(d);return!Nu.has(p)&&Nu.has(`${p}/README`)&&(p=`${p}/README`),Nu.has(p)?re.jsx(Xu,{to:`/api/${p}`,...g,children:f}):re.jsx("a",{href:d,...g,children:f})}},children:s.content})})]}):re.jsx("section",{className:"section api-layout",children:re.jsxs("article",{className:"api-content",children:[re.jsx("h2",{children:"API Reference"}),re.jsxs("p",{children:["API docs are not available. Run ",re.jsx("code",{children:"pnpm docs:api"})," first."]})]})})}const Uu="https://stackblitz.com/github/ZizzX/wizzard-packages/tree/dev/.stackblitz",xx=[{title:"Validation",description:"Zod/Yup adapters with step-level validation.",href:`${Uu}/validation`},{title:"Persistence",description:"LocalStorage + memory adapters with auto-save.",href:`${Uu}/persistence`},{title:"Navigation",description:"Sequential, visited, and free navigation modes.",href:`${Uu}/basic`}];function Dx(){return re.jsxs("section",{className:"section",children:[re.jsxs("div",{className:"section-header",children:[re.jsx("p",{className:"section-eyebrow",children:"Cookbook"}),re.jsx("h2",{children:"Examples"}),re.jsx("p",{className:"section-lead",children:"Start from working recipes and customize the steps for your product."})]}),re.jsx("div",{className:"card-grid",children:xx.map(a=>re.jsxs("a",{className:"card card--link",href:a.href,target:"_blank",rel:"noreferrer",children:[re.jsx("h3",{children:a.title}),re.jsx("p",{children:a.description}),re.jsx("span",{className:"card-cta",children:"Open StackBlitz"})]},a.title))})]})}const Tx=gS([{path:"/",element:re.jsx(CS,{}),children:[{index:!0,element:re.jsx(LS,{})},{path:"api/*",element:re.jsx(Ex,{})},{path:"examples",element:re.jsx(Dx,{})}]}],{basename:"/wizzard-packages/dev/"});function Ax(){return re.jsx(DS,{router:Tx})}const Dg=document.getElementById("root");Dg&&Hb.createRoot(Dg).render(re.jsx(Ag.StrictMode,{children:re.jsx(Ax,{})}));
